...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Best Artificial Intelligence Course in Delhi - Learnbay"
        />
        <meta
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress:
                  'Business Centre, Arunachal Building 6th floor, Barakhamba Rd',
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the Artificial Intelligence training course in Delhi varies from 9 months to 13 months."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Depending on the artificial intelligence course with Gen AI you chose, the course fees vary from 1,20,000 to 1,59,000 INR."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Artificial intelligence training course in Delhi offers IBM and Microsoft certification with exclusive project certificate."
    }
  },{
    "@type": "Question",
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              Courselink6={AIelhiCourseData[0].Courselink6}
              ...
              Course6={AIelhiCourseData[0].Course6}

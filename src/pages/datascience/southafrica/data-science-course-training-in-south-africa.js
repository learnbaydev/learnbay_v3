...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Master Your Skills With Learnbay’s Data Science Course In South Africa with GenAI. Get IBM certifications with job support to secure your future—Join today."
        />
        <meta
          name="keywords"
  ...
  "@type": "Product",
  "name": "Best Data Science Course Online in South Africa - Learnbay",
  ...
  "@type": "Course",
  "name": "Best Data Science Course Online in South Africa - Learnbay",
  "description": "Master Your Skills With Learnbay’s Data Science Course In South Africa with GenAI. Get IBM certifications with job support to secure your future—Join today.",
  "url": "https://www.learnbay.co/datascience/southafrica/data-science-course-training-in-south-africa",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What are Data Science Training courses available at Learnbay in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Data Science and GenAI Certification Program, Advance Data Science and GenAI Master program, GenAI and Agentic AI Program for Managers and Leaders."
    }
  },{
    "@type": "Question",
    "name": "What are the prerequisites for these Data Science training Courses in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is a Flexi Subscription in these advanced data science courses in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What’s the duration of these advanced data science courses in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of these courses is about 9-13 months, which includes live lectures, hands-on practical training on live projects, and interview preparations. Classes will be conducted on weekdays and weekend batches. For the non-master program, around 9 months is the timeline, while the master program will get an extension for around 13 months."
    }
  },{
    "@type": "Question",
    "name": "What is the mode of data science training in South Africa at Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How can I opt for a Hybrid mode of learning in IBM data science training courses in South Africa, At Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is domain specialization in the professional data science certification courses provided by Learnbay in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the available elective domain options in the different data science training courses of Learnbay in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the total fee for Data Science Certifications courses in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total fees of this GenAI and Data Science Certification Course in South Africa is around $1700."
    }
  },{
    "@type": "Question",
    "name": "Can I pay in installments for these Data Science Certification courses in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, Installments remain available as per ongoing promotional offers. You can contact our career counselor for some customized deals."
    }
  },{
    "@type": "Question",
    "name": "Is there any scholarship/discount available for these Data Science training courses available in South Africa? What is Group Discount?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How will the projects be executed in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The data science course in South Africa comes with an integrated dual Certification from IBM (one course completion and one project certificate). In case you choose the Master program, then you get an additional certification."
    }
  },{
    "@type": "Question",
    "name": "What's the eligibility for a job assistance Program in Learnbay Data science training courses in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I get support for job assistance at Learnbay in South Africa?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Can a Learnbay student in South Africa choose to study from their desired mentor?",
    "acceptedAnswer": {
      "@type": "Answer",

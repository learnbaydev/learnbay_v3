    ...
    <div className={styles.container}>
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: `${MLBangaloreCourseData[0].script1}`,
          }}
        />{" "}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: ` ${MLBangaloreCourseData[0].script2}`,
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: ` ${MLBangaloreCourseData[0].script3} `,
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: ` ${MLBangaloreCourseData[0].script4} `,
          }}
        />
      </Head>
      <main>

...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Best Artificial Intelligence Course in Bangalore - Learnbay"
        />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `{ 
              ...
              "description": "Learnbay offers the best Artificial Intelligence Training in Bangalore. Get mentorship from the industry experts with best career assistance. Enroll Now.",
  ...
  "@type": "Product", 
  "name": "Best Artificial Intelligence Course in Bangalore - Learnbay",
  "image": "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/learnbayMain/learnbay-logo.png",
  "brand": {
    "@type": "Brand",
    "name": "Learnbay"

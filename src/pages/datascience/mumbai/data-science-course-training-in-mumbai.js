  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Data Science Course in Mumbai With IBM Certification"
        />
        <meta
...
"
  ...
  "@type": "Product",
  "name": "Data Science Course in Mumbai - Learnbay",
  ...
  "aggregateRating": {
    ...
    "ratingCount": "510"
      ...
      "@type": "Course",
      "name": "Data Science Course in Mumbai - Learnbay",
      "description": "Gain Competitive Edge In Todays World With Learnbay’s Data Science Course In Mumbai. Enrol Now To Learn From Industry Experts And Boost Your Data Science Career",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What are Data Science Courses available at Learnbay in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the prerequisites for these Data Science Courses in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is a Flexi Subscription in these advanced data science courses in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What’s the duration of these advanced data science courses in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the mode of data science in Mumbai at Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How can I opt for a Hybrid mode of learning in IBM data science training courses in Mumbai, At Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total course fees depend on which particular course you choose from the data science and agentic AI category. Usually course price will vary from 1,20,000 to 1,59,000 INR, exclusive of GST."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "you will get a total of 3 to 4 certifications: Course Completion Certification from IBM Certification, Gen AI Certification from IBM, and Capstone Project Certification. For a few advanced and Master Program there will be additional IBM certification also."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "At Learnbay, you will be required to work in a group where your project group will be assigned a specific project mentor with complete assistance and guidance.At Learnbay, you will be required to work in a group where your project group will be assigned a specific project mentor with complete assistance and guidance."
    }
  },{
    "@type": "Question",
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              src44={DataScienceMumbaiCourseData[0].src44}

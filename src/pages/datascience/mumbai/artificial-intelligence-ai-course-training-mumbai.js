...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Master Artificial Intelligence & GenAI in Mumbai. Learnbay offers IBM certified AI training with 10+ live projects and job assist. Enroll for GenAI today!"
        />
        <meta
          property="og:url"
        ...
        <meta
          property="og:title"
          content="Artificial Intelligence Course in Mumbai with Job Assistance"
        />
        <meta
        ...
        <meta
          name="keywords"
          content="artificial intelligence course in mumbai, ai training in mumbai, generative ai course mumbai, best ai institute in mumbai, machine learning and genai training, ibm certified ai course, ai for working professionals mumbai, learnbay mumbai, genai certification mumbai"
        />
        <link
          rel="canonical"
  ...
  "@type": "Product",
  "name": "Artificial Intelligence Course in Mumbai with Job Assistance",
...
`,
      ...
      "@type": "Course",
      "name": "Artificial Intelligence Course in Mumbai with Job Assistance",
      "description": "Master Artificial Intelligence & GenAI in Mumbai. Learnbay offers IBM certified AI training with 10+ live projects and job assist. Enroll for GenAI today!",
...
`,
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The Duration of this course is 13 months."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The fees of this artificial intelligence course in Mumbai is 1,59,000 INR excluding GST."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "It offers a total of 4 certifications. Course Completion from IBM, Gen-AI from IBM, Project certification and Microsoft Certification."
    }
  },{
    "@type": "Question",
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              Courselink6={AIMumbaiCourseData[0].Courselink6}
              ...
              Course6={AIMumbaiCourseData[0].Course6}

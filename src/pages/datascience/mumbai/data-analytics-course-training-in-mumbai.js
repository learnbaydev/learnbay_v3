...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Join our comprehensive Data Analytics Training program in Mumbai to become a GenAI skilled Data Analyst in collaboration with IIT Patna. Enroll Now."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Data Analytics Course in Mumbai | IIT Patna Certified"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Data Analytics Course in Mumbai | IIT Patna Certified",
  ...
  "aggregateRating": {
    ...
    "ratingCount": "630"
      ...
      "@type": "Course",
      "name": "Data Analytics Course in Mumbai | IIT Patna Certified - Learnbay",
      "description": "Join our comprehensive Data Analytics Training program in Mumbai to become a GenAI skilled Data Analyst in collaboration with IIT Patna. Enroll Now.",
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "There are no prerequisites for this Data Analytics certification course in Mumbai as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is a Flexi Subscription in the Data Analytics Certification Course in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the data analytics course in Mumbai is 6 months."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is domain specialization associated with the Learnbay data analytics certification course in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We offer industry-specific full-stack data analytics with Gen AI modules, via which you learn the respective industry’s best practices."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "How many real-projects will be there?",
    "acceptedAnswer": {
      "@type": "Answer",

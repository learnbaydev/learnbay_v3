...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Business Analytics Course Training in Mumbai</title>
        ...
        <meta
          property="og:title"
          content="Best Business Analyst Certification Course in Mumbai"
        />
        <meta
...
"@context": "https://schema.org",
  "@type": "Product",
  "name": "Business Analytics Course Training in Mumbai - Learnbay",
...
"@context": "http://schema.org",
      "@type": "Course",
      "name": "Business Analytics Course Training in Mumbai - Learnbay",
      "description": "Master Business Analytics in Mumbai with Learnbay. Get IBM & IIT Patna certification. 200+ hours of training in GenAI-infused modules. Designed for working pros",
  ...
  "mainEntity": [{
    ...
    "@type": "Question",
    "name": "What’s the duration of the Business Analytics Course in Mumbai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The Duration of the business analytics course in Mumbai is 6 months."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, can pay in instalments using a credit card with a no-cost EMI option for up to 12 months. You can also choose an interest-free loan by submitting an Aadhar card, PAN card, and a 3-month salary slip. Please check with our sales team to know more +917795687988"
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes you will be awarded one IBM course completion certificate, one Project certificate and one IIT Patna Certificate."
    }
  },{
    "@type": "Question",

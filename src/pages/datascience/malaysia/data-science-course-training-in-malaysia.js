...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Best Online Data Science Course in Malaysia | Learnbay"
        />
        <meta
  ...
  "@type": "Product", 
  "name": "Best Online Data Science Course in Malaysia | Learnbay",
  ...
  "@type": "Course",
  "name": "Best Online Data Science Course in Malaysia | Learnbay",
  "description": "Proliferate your career success with a Data Science course in Malaysia. Master the essentials of data science with expert guidance and real-time projects.",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What are Data Science Training courses available at Learnbay in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the prerequisites for these Data Science training Courses in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is a Flexi Subscription in these advanced data science courses in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What’s the duration of these advanced data science courses in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total duration of these courses is about 9-13 months, including live lectures, hands-on practical training on live projects, and interview preparation. Classes will be conducted on weekdays and in weekend batches. For a non-master's program, the duration is around 9 months, while the master's program is around 13 months."
    }
  },{
    "@type": "Question",
    "name": "What is the mode of data science training in Malaysia at Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How can I opt for a Hybrid mode of learning in IBM data science training courses in Malaysia, At Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is domain specialization in the professional data science certification courses provided by Learnbay in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the available elective domain options in the different data science training courses of Learnbay in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the total fee for Data Science Certifications courses in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total course fee for the data science course in Malaysia is $1700."
    }
  },{
    "@type": "Question",
    "name": "Can I pay in installments for these Data Science Certification courses in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Is there any scholarship/discount available for these Data Science training courses available in Malaysia? What is Group Discount?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Depending on the course you choose, the number of capstone projects will vary. Usually, you get multiple capstone projects. You can also build your own project using our BYOP feature. Click here to download the list of projects. Click here to download the list of the projects."
    }
  },{
    "@type": "Question",
    "name": "How will the projects be executed in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The data science course in Malaysia includes an integrated dual Certification from IBM (one course completion certificate and one project certificate)."
    }
  },{
    "@type": "Question",
    "name": "What's the eligibility for a job assistance Program in Learnbay Data science training courses in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I get support for job assistance at Learnbay in Malaysia?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Can a Learnbay student in Malaysia choose to study from their desired mentor?",
    "acceptedAnswer": {
      "@type": "Answer",

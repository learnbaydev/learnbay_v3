...
export default function Home() {
  ...
  "description": "Join the Best Artificial Intelligence Training Course in Pune at Learnbay. Earn IBM Certification and job assistance to advance your career. Apply Now!",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `{ 
              "@context": "https://schema.org",
  "@type": "Product",
  "name": "Best Artificial Intelligence Course in Pune - Learnbay",
  "image": "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/learnbayMain/learnbay-logo.png",
  "brand": {
    "@type": "Brand",
    "name": "Learnbay"
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total course fee for the Artificial Intelligence Training Course in Pune is 1,59,000 + 18% GST."
    }
  },{
    "@type": "Question",

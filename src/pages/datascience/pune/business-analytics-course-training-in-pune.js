...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Business Analyst Certification Course in Pune - Learnbay"
        />
        <meta
  ...
  "description": "Enroll Today in Learnbay's Business Analyst Training in Pune for expert teaching and Capstone Projects. Gain valuable skills with IBM Certification.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `{ 
              "@context": "https://schema.org",
  "@type": "Product",
  "name": "Business Analyst Certification Course in Pune - Learnbay",
  "image": "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/learnbayMain/learnbay-logo.png",
  "brand": {
    "@type": "Brand",
    "name": "Learnbay"
...
`,
  ...
  "mainEntity": [{
    ...
    "@type": "Question",
    "name": "What’s the duration of the Business Analytics Course in Pune?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the Business Analytics course training in Pune is 8-9 months, including weekend and weekday batches."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is domain specialization associated with the Learnbay business analytics course in Pune?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We offer industry-specific full-stack business analytics with gen AI modules that teach you the best practices of the respective industry."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "After enrolling in the business analytics course with domain specialisation course, one must opt for domain electives. It is essential to have business/industry knowledge that is useful in feature engineering and modeling. Prior knowledge of the industry and domain aids in the development of more precise and accurate predictive models based on the dataset's attributes. Furthermore, the model will be more observable in a real-world situation."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, you will be awarded IBM and IIT Patna Vislehsan accredited Business Analytics Certificate on successful course completion."
    }
  },{
    "@type": "Question",

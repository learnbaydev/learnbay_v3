    ...
    <div className={styles.container}>
      ...
      <title>Best Data Science Course in Dubai With IBM Certification</title>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: `${DSDubaiCourseData[0].script1}`,
          }}
        />{" "}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: ` ${DSDubaiCourseData[0].script2}`,
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: ` ${DSDubaiCourseData[0].script3} `,
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: ` ${DSDubaiCourseData[0].script4} `,
          }}
        />
      </Head>
      <main>
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              SyllabusBotlist11={
                DSDubaiCourseData[0].SyllabusBotlist11
              }
              SyllabusBotlist12={
                DSDubaiCourseData[0].SyllabusBotlist12
              }
              SyllabusBotlist13={
                DSDubaiCourseData[0].SyllabusBotlist13
              }
              SyllabusBotlist14={
                DSDubaiCourseData[0].SyllabusBotlist14
              }
              SyllabusBotlist15={
                DSDubaiCourseData[0].SyllabusBotlist15
              }
              SyllabusBotlist16={
                DSDubaiCourseData[0].SyllabusBotlist16
              }
              syllabush2={DSDubaiCourseData[0].syllabush2}
              syllabusb2={DSDubaiCourseData[0].syllabusb2}
              SyllabusBotlist21={
                DSDubaiCourseData[0].SyllabusBotlist21
              }
              SyllabusBotlist22={
                DSDubaiCourseData[0].SyllabusBotlist22
              }
              SyllabusBotlist23={
                DSDubaiCourseData[0].SyllabusBotlist23
              }
              SyllabusBotlist24={
                DSDubaiCourseData[0].SyllabusBotlist24
              }
              SyllabusBotlist25={
                DSDubaiCourseData[0].SyllabusBotlist25
              }
              SyllabusBotlist26={
                DSDubaiCourseData[0].SyllabusBotlist26
              }
              syllabush3={DSDubaiCourseData[0].syllabush3}
              syllabusb3={DSDubaiCourseData[0].syllabusb3}
              SyllabusBotlist31={
                DSDubaiCourseData[0].SyllabusBotlist31
              }
              SyllabusBotlist32={
                DSDubaiCourseData[0].SyllabusBotlist32
              }
              SyllabusBotlist33={
                DSDubaiCourseData[0].SyllabusBotlist33
              }
              SyllabusBotlist34={
                DSDubaiCourseData[0].SyllabusBotlist34
              }
              SyllabusBotlist35={
                DSDubaiCourseData[0].SyllabusBotlist35
              }
              SyllabusBotlist36={
                DSDubaiCourseData[0].SyllabusBotlist36
              }
              syllabush4={DSDubaiCourseData[0].syllabush4}
              syllabusb4={DSDubaiCourseData[0].syllabusb4}
              SyllabusBotlist41={
                DSDubaiCourseData[0].SyllabusBotlist41
              }
              SyllabusBotlist42={
                DSDubaiCourseData[0].SyllabusBotlist42
              }
              SyllabusBotlist43={
                DSDubaiCourseData[0].SyllabusBotlist43
              }
              SyllabusBotlist44={
                DSDubaiCourseData[0].SyllabusBotlist44
              }
              SyllabusBotlist45={
                DSDubaiCourseData[0].SyllabusBotlist45
              }
              SyllabusBotlist46={

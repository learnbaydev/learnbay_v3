...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Data Science Course in Dubai, UAE | IBM GenAI Certificate</title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content="Learnbay offers the Best Data Science Training in Dubai with the latest GenAI modules, Real Industry Projects, AI Co-lab, & dedicated job assist. Enroll today!"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Data Science Course in Dubai, UAE | IBM GenAI Certificate"
        />
        <meta
          property="og:description"
          content="Learnbay offers the Best Data Science Training in Dubai with the latest GenAI modules, Real Industry Projects, AI Co-lab, & dedicated job assist. Enrol today!"
        />
        <meta
          property="og:image"
  ...
  "@type": "Product",
  "name": "Data Science Course in Dubai, UAE | IBM GenAI Certificate",
  ...
  "@type": "Course",
  "name": "Data Science Course in Dubai, UAE | IBM GenAI Certificate",
  "description": "Learnbay offers the Best Data Science Training in Dubai with the latest GenAI modules, Real Industry Projects, AI Co-lab, & dedicated job assist. Enrol today!",
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "If you enrol for data science course training in Dubai with Gen AI or the Advance Data science and Gen AI Course in Dubai, you get 3 years of flexi subscriptions. This is without any additional cost."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the Data Science Course in Dubai is 9-13 months, including weekend and weekday batches."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is domain specialization in the professional data science certification courses provided by Learnbay in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the available elective domain options in the different data science training courses of Learnbay in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
...
And no, you need not to pay any extra charges for domain electives."
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Depending on course you choose, like Certification or Advacne Master program in  Data science and Gen AI, Dubai, the number of capstone project might vary sometime. Also it depends on your chosen domain. However, usually you get 2 capstone project (Domain Specific), and 28+ real-time industry projects with AI Co-lab. Here, you get Bring Your Own Business Problem Project facilities also."
    }
  },{
    "@type": "Question",

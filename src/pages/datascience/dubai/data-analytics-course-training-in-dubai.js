...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Data Analytics Certification Course in Dubai with Gen AI</title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content="Advance your career with Learnbay's Data Analytics training in Dubai. Gain expert guidance, IBM certificate, live industry projects & 100% job assist.
"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Data Analytics Certification Course in Dubai with Gen AI"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Data Analytics Certification Course in Dubai with Gen AI",
...
`,
  ...
  "@type": "Course",
  "name": "Data Analytics Certification Course in Dubai with Gen AI",
  "description": "Advance your career with Learnbay's Data Analytics training in Dubai. Gain expert guidance, IBM certificate, live industry projects & 100% job assist.",
...
`,
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the data analytics course in Dubai is 6 months."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Upon successful completion of the data analytics course in Dubai, you will receive 3 certifications, two from IBM and one from IIT Patna."
    }
  },{
    "@type": "Question",

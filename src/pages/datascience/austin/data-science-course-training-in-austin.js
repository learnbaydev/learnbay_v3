...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Best Online Data Science Course in Austin - Learnbay"
        />
        <meta
  ...
  "@type": "Product", 
  "name": "Best Online Data Science Course in Austin - Learnbay",
  ...
  "@type": "Course",
  "name": "Best Online Data Science Course in Austin - Learnbay",
  "description": "Gain the skills you need with Learnbay's best online data science course in Austin. Join a Group of learners, way in top-notch Support, and advance your career.",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What are Data Science Training courses available at Learnbay in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Data Science and GenAI Certification Program, Advance Data Science and GenAI Master program, GenAI and Agentic AI Program for Managers and Leaders are available in Austin."
    }
  },{
    "@type": "Question",
    "name": "What are the prerequisites for these Data Science training Courses in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is a Flexi Subscription in these advanced data science courses in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What’s the duration of these advanced data science courses in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the mode of data science training in Austin at Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How can I opt for a Hybrid mode of learning in IBM data science training courses in Austin, At Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is domain specialization in the professional data science certification courses provided by Learnbay in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the available elective domain options in the different data science training courses of Learnbay in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the total fee for Data Science Certifications courses in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total course fees depend on which particular course you choose from the data science and agentic AI categories. Usually, the course price starts from $1700."
    }
  },{
    "@type": "Question",
    "name": "Can I pay in installments for these Data Science Certification courses in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Is there any scholarship/discount available for these Data Science training courses available in Austin? What is Group Discount?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What's the eligibility for a job assistance Program in Learnbay Data science training courses in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I get support for job assistance at Learnbay in Austin?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Can a Learnbay student in Austin choose to study from their desired mentor?",
    "acceptedAnswer": {
      "@type": "Answer",

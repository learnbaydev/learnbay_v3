...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Best Data Science Course in Chennai With IBM Certification"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Data Science Course in Chennai With IBM Certification",
...
`,
      ...
      "@type": "Course",
      "name": "Best Data Science Course in Chennai With IBM Certification",
      "description": "Earn Dual Certifications From Learnbay's Data Science Training Course In Chennai And Get Placement Assistance To Advance Your Career In Data Science.",
...
`,
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the Data Science Course Training In Chennai is 9-13 months, including weekend and weekday batches.s"
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You’ll be provided 5 interview calls after the completion of the course."
    }
  },{
    "@type": "Question",

...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Get Job Ready Artificial Intelligence Training in Chennai. Learnbay offers IBM Certified GenAI Certification in Chennai with placement. Enquire Now!"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Artificial Intelligence Course in Chennai - Learnbay"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Artificial Intelligence Course in Chennai - Learnbay",
  ...
  "@type": "Course",
  "name": "Best Artificial Intelligence Course in Chennai - Learnbay",
  "description": "Get Job Ready Artificial Intelligence Training in Chennai. Learnbay offers IBM Certified GenAI Certification in Chennai with placement. Enquire Now!",
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the artificial intelligence course in Chennai is 13 months."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The fee for this artificial intelligence course in Chennai is 1,59,000 INR, excluding GST."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "It offers 4 certifications in total. Course Completion from IBM, Gen-AI from IBM, Project certification, and Microsoft Certification."
    }
  },{
    "@type": "Question",

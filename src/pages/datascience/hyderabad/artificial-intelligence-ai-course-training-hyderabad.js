...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Learnbay's Artificial Intelligence Training program in Hyderabad with Gen AI & IBM certification offers 100% job assist, real industry projects. Sign up now."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Artificial Intelligence Course in Hyderabad | Learnbay"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Artificial Intelligence Course in Hyderabad | Learnbay",
...
`,
  ...
  "@type": "Course",
  "name": "Best Artificial Intelligence Course in Hyderabad | Learnbay",
  "description": "Learnbay's Artificial Intelligence Training program in Hyderabad with Gen AI & IBM certification offers 100% job assist, real industry projects. Sign up now.",
...
`,
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration should be 13 months, including weekends and weekday batches."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Change the name to hyderabad and the fees to ₹1,59,000 + 18% GST."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes. Working professionals will receive globally accredited certifications from IBM, Microsoft, and real AI startups. You will earn: One IBM course completion, Generative AI Certificate Three Microsoft Azure AI Fundamentals Two AI Co-Lab Project Certificates"
    }
  },{
    "@type": "Question",
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              Courselink6={AIHyderabadCourseData[0].Courselink6}
              ...
              Course6={AIHyderabadCourseData[0].Course6}

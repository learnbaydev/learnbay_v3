...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>
          Best IBM Certified Data Analytics Course in Hyderabad | Learnbay
        </title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content="Upgrade your analytics skills with Learnbay’s Data Analytics Training in Hyderabad. Acquire industry-ready projects with IIT Patna Certificate. Apply Now!"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best IBM Certified Data Analytics Course in Hyderabad | Learnbay"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best IBM Certified Data Analytics Course in Hyderabad | Learnbay",
  ...
  "@type": "Course",
  "name": "Best IBM Certified Data Analytics Course in Hyderabad | Learnbay",
  "description": "Upgrade your analytics skills with Learnbay’s Data Analytics Training in Hyderabad. Acquire industry-ready projects with IIT Patna Certificate. Apply Now!",
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of the Data Analytics Course Training in Hyderabad is around 6 months, including weekend and weekday batches."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, you will be awarded IIT Patna and Gen AI certification on successful course completion."
    }
  },{
    "@type": "Question",

...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Best Online Data Science Course in UK - Learnbay</title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content="Advance your career with the best Online Data Science Training in UK by Learnbay. Master GenAI skills & work on domain-specific real-world projects. Join now!"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Online Data Science Course in UK  - Learnbay"
        />
        <meta
  ...
  "@type": "Product", 
  "name": "Best Online Data Science Course in UK  - Learnbay",
...
`,
  ...
  "@type": "Course",
  "name": "Best Online Data Science Course in UK  - Learnbay",
  "description": "Advance your career with the best Online Data Science Training in UK by Learnbay. Master GenAI skills & work on domain-specific real-world projects. Join now!",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
...
`,
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What are Data Science Training courses available at Learnbay in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the prerequisites for these Data Science training Courses in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "There are no prerequisites for this Data Science training Courses in UK as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-Programmers. However, basic knowledge of applied Mathematics/Statistics is a must."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is a Flexi Subscription in these advanced data science courses in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What’s the duration of these advanced data science courses in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total duration of these courses is about 9-13 months and includes live lectures, hands-on practical training on live projects, and interview preparation. Classes will be conducted on weekdays and on weekends."
    }
  },{
    "@type": "Question",
    "name": "What is the mode of data science training in UK at Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How can I opt for a Hybrid mode of learning in IBM data science training courses in UK, At Learnbay?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is domain specialization in the professional data science certification courses provided by Learnbay in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the available elective domain options in the different data science training courses of Learnbay in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the total fee for Data Science Certifications courses in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total course fee for the data science course in UK will cost you around $1700."
    }
  },{
    "@type": "Question",
    "name": "Can I pay in installments for these Data Science Certification courses in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Is there any scholarship/discount available for these Data Science training courses available in UK? What is Group Discount?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How will the projects be executed in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The data science course in UK comes with an integrated dual Certification from IBM (one course completion and one project certificate)."
    }
  },{
    "@type": "Question",
    "name": "What's the eligibility for a job assistance Program in Learnbay Data science training courses in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I get support for job assistance at Learnbay in UK?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Can a Learnbay student in UK choose to study from their desired mentor?",
    "acceptedAnswer": {
      "@type": "Answer",

...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Looking for the best data science course in Kolkata? Learnbay provides the best data science course training in Kolkata with GenAI placement assist."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Data Science Courses Training in Kolkata - Learnbay"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Data Science Courses Training in Kolkata - Learnbay",
  ...
  "@type": "Course",
  "name": "Best Data Science Courses Training in Kolkata - Learnbay",
  "description": "Looking for the best data science course in Kolkata? Learnbay provides the best data science course training in Kolkata with GenAI placement assist.",
  "url": "https://www.learnbay.co/datascience/india/data-science-course-training-in-kolkata",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long does the data science course in Kolkata typically take to complete?",
    "acceptedAnswer": {
      "@type": "Answer",
...
Generative AI concepts"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Kolkata."
    }
  },{
    "@type": "Question",
...
HR"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learners opting for the data science course at Learnbay are advised to go through its Refund/Cancellation Policy before Refund/Cancellation Policy enrolling. The policy mentions that learners can withdraw their data science fees in Kolkata."
    }
  },{
    "@type": "Question",

...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>
          Best Data Science Course in Coimbatore with IBM Certificate
        </title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content="Data science Course in Coimbatore by Learnbay offers latest GenAI modules, 28+ real-time projects, Bring Your Own Project Features & 100% job assist. "
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Data Science Course in Coimbatore with IBM Certificate"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Data Science Course in Coimbatore with IBM Certificate",
  ...
  "@type": "Course",
  "name": "Best Data Science Course in Coimbatore with IBM Certificate",
  "description": "Data science Course in Coimbatore by Learnbay offers latest GenAI modules, 28+ real-time projects, Bring Your Own Project Features & 100% job assist.",
  "url": "https://www.learnbay.co/datascience/india/data-science-course-training-in-coimbatore",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long does the data science course in Coimbatore typically take to complete?",
    "acceptedAnswer": {
      "@type": "Answer",
...
Generative AI concepts"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Coimbatore with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Coimbatore."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "xYes, domain electives and associated projects are updated according to industry trends. Domain electives are inspired by the sectors that are trending with attractive job offers for data scientists and have been thriving in recent years."
    }
  },{
    "@type": "Question",
...
HR"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learners opting for the data science course at Learnbay are advised to go through its Refund/Cancellation Policy before Refund/Cancellation Policy enrolling. The policy mentions that learners can withdraw their data science fees in Coimbatore."
    }
  },{
    "@type": "Question",

...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Learnbay offers the best data science course in Jaipur. Advance your career with GenAI, real-world projects, IBM certificate & top-tire placement assist."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Data Science Course in Jaipur - Learnbay"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Data Science Course in Jaipur - Learnbay",
...
`,
  ...
  "@type": "Course",
  "name": "Best Data Science Course in Jaipur - Learnbay",
  "description": "Learnbay offers the best data science course in Jaipur. Advance your career with GenAI, real-world projects, IBM certificate & top-tire placement assist.",
  "url": "https://www.learnbay.co/datascience/india/data-science-course-training-in-jaipur",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
...
`,
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long does the data science course in Jaipur typically take to complete?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Jaipur with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Jaipur."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learners opting for the data science course at Learnbay are advised to go through its Refund/Cancellation Policy before Refund/Cancellation Policy enrolling. The policy mentions that learners can withdraw their data science fees in Jaipur."
    }
  },{
    "@type": "Question",

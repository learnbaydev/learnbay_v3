  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Enroll in our data science course and equip yourself with trending GenAI skills. Get the best data science training in Bhubaneswar with placement assist. "
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Best Data Science Course Institute in Bhubaneswar | Learnbay"
        />
        <meta
...
"
  ...
  "@type": "Product",
  "name": "Best Data Science Course Institute in Bhubaneswar | Learnbay",
  ...
  "@type": "Course",
  "name": "Best Data Science Course Institute in Bhubaneswar | Learnbay",
  "description": "Enroll in our data science course and equip yourself with trending GenAI skills. Get the best data science training in Bhubaneswar with placement assist.",
  "url": "https://www.learnbay.co/datascience/india/data-science-course-training-in-bhubaneswar",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long does the data science course in Bhubaneswar typically take to complete?",
    "acceptedAnswer": {
      "@type": "Answer",
...
Generative AI concepts"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Bhubaneswar with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Bhubaneswar."
    }
  },{
    "@type": "Question",
    "name": "Can I attend classes online, or is it only available in a physical classroom?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Kolkata with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility."
    }
  },{
    "@type": "Question",
...
HR"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learners opting for the data science course at Learnbay are advised to go through its Refund/Cancellation Policy before Refund/Cancellation Policy enrolling. The policy mentions that learners can withdraw their data science fees in Bhubaneswar."
    }
  },{
    "@type": "Question",

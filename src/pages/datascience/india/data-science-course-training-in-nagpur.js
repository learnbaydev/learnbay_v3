...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Best Data Science Course in Nagpur | Learnbay"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Best Data Science Course in Nagpur | Learnbay",
  ...
  "@type": "Course",
  "name": "Best Data Science Course in Nagpur | Learnbay",
  "description": "Enroll in the best data science course in Nagpur. Gain hands-on experience on generative AI modules and earn globally recognized certifications.",
  "url": "https://www.learnbay.co/datascience/india/data-science-course-training-in-nagpur",
  "provider": {
    "@type": "Organization",
    "name": "Learnbay",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long does the data science course in Nagpur typically take to complete?",
    "acceptedAnswer": {
      "@type": "Answer",
...
Generative AI concepts"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Nagpur with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Nagpur."
    }
  },{
    "@type": "Question",
...
Group of 4+: Max 10% discount"
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learners opting for the data science course at Learnbay are advised to go through its Refund/Cancellation Policy before Refund/Cancellation Policy enrolling. The policy mentions that learners can withdraw their data science fees in Nagpur."
    }
  },{
    "@type": "Question",

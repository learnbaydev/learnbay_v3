...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Full Stack Developer Course in Bangalore - Learnbay"
        />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `{ 
              ...
              "description": "Want to become a skilled Web Developer? Enroll Now - Learnbay's Most Extensive Full Stack Web Developer Course in Bangalore.",
  ...
  "@type": "Product", 
  "name": "Full Stack Developer Course in Bangalore - Learnbay",
  "image": "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/learnbayMain/learnbay-logo.png",
  "brand": {
    "@type": "Brand",
    "name": "Learnbay"
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is Learnbay’s full-stack developer course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learnbay's full-stack developer course is essentially the finest course in software development available in Bangalore. Here the learners are trained with a hands-on method to develop software applications using a selection of the most in-demand programming languages."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is a 'Flexi Subscription' in the full stack software development course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the essential skills in a software development course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What will be the program duration for this full-stack software developer course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The full-stack software developer course with Gen Ai and Agentic AI is about 11 months for the Master program, while the non-master Gen AI and Agentic AI certification for software developers is of 5 months."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is Domain Specialization associated with the full-stack software developer course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "In Bangalore, Learnbay’s Full stack software development course provides domains such as Full Stack, Product Engineer/Manager, Data Science & AI, Web 3.0 Developer, and DevOps & Clouds."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "How much is the full-stack software developer course fee in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total cost of the full-stack software development course in Bangalore is INR 1,59,000 plus 18% GST, the non master certification course with a shorter duration is of 1,20,000/- + GST."
    }
  },{
    "@type": "Question",
    "name": "Is there any Installment / EMI option available for this course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, you can use a credit card to pay the installments with a no- fee EMI option. By presenting a valid copy of the Aadhar card, Pan card, and the latest three months' salary, you can also avail of an interest-free loan also. For further details, you can contact@ +917795687988"
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "Does Learnbay provide webinars and hackathons in full-stack development courses in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I receive job referrals after completing a full-stack development course in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the documents required to enroll in the full-stack developer program in Bangalore?",
    "acceptedAnswer": {
      "@type": "Answer",

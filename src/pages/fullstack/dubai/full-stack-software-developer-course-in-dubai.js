...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Become A Certified in Full Stack Software Developer with Best Full Stack Training Course in Dubai by Learnbay with live project & GenAI. Enroll Now."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Full Stack Developer Course in Dubai with Job Assistance"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Full Stack Developer Course in Dubai with Job Assistance",
  ...
  "@type": "Course",
  "name": "Full Stack Developer Course in Dubai with Job Assistance",
  "description": "Become A Certified in Full Stack Software Developer with Best Full Stack Training Course in Dubai by Learnbay with live project & GenAI. Enroll Now.",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is Learnbay’s full-stack developer course in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learnbay's full-stack developer course is essentially the finest course in software development available in Dubai. Here the learners are trained with a hands-on method to develop software applications using a selection of the most in-demand programming languages."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is a 'Flexi Subscription' in the full stack software development course in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is Domain Specialization associated with the full-stack software developer course in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
...
Automation with Agentic AI, GenAI & Agentic AI for Product Managers"
    ...
    "@type": "Question",
    "name": "How much is the full-stack software developer course fee in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total cost of a full-stack software development course in Dubai with agentic AI is 1,59,000 INR, excluding tax."
    }
  },{
    "@type": "Question",
    "name": "Is there any Installment / EMI option available for this course in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the documents required to enroll in the full-stack developer program in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the average full-stack software developer salary in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Does Learnbay provide webinars and hackathons in full-stack development courses in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I receive job referrals after completing a full-stack development course in Dubai?",
    "acceptedAnswer": {
      "@type": "Answer",

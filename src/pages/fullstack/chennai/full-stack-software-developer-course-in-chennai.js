...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Full Stack Developer Course in Chennai | IBM | GenAI</title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content="Master Full Stack Development in Chennai with GenAI & System Design. Get IBM & Microsoft certified, job assist, & 15+ live projects. Enroll now!"
        />
        <meta
          name="keywords"
          content="Full Stack Developer Course in Chennai, Software Developer Training Chennai, IBM Certified Developer, GenAI Full Stack Course, MERN Stack Chennai, Agentic AI, System Design."
        />
        <meta
          property="og:url"
        ...
        <meta
          property="og:title"
          content="Full Stack Developer Course in Chennai | IBM | GenAI"
        />
        <meta
  ...
  "@type": "Product",
  "name": "Full Stack Developer Course in Chennai | IBM | GenAI",
  ...
  "@type": "Course",
  "name": "Full Stack Developer Course in Chennai | IBM | GenAI",
  "description": "Master Full Stack Development in Chennai with GenAI & System Design. Get IBM & Microsoft certified, job assist, & 15+ live projects. Enroll now!",
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is Learnbay’s full-stack developer course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learnbay's full-stack developer course is essentially the finest course in software development available in Chennai. Here the learners are trained with a hands-on method to develop software applications using a selection of the most in-demand programming languages."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is a 'Flexi Subscription' in the full stack software development course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the essential skills in a software development course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What will be the program duration for this full-stack software developer course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration of this software development course with Agentic AI in Chennai is 11 months."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "What is Domain Specialization associated with the full-stack software developer course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "In Chennai, Learnbay’s Full stack software development course provides domains such as Full Stack, Product Engineer/Manager, Data Science & AI, Web 3.0 Developer, and DevOps & Clouds."
    }
  },{
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "How much is the full-stack software developer course fee in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The total cost of a full-stack software development course in Chennai with agentic AI is 1,59,000 INR, excluding tax."
    }
  },{
    "@type": "Question",
    "name": "Is there any Installment / EMI option available for this course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What are the documents required to enroll in the full-stack developer program in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "Does Learnbay provide webinars and hackathons in full-stack development courses in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "How long will I receive job referrals after completing a full-stack development course in Chennai?",
    "acceptedAnswer": {
      "@type": "Answer",

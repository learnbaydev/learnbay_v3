  ...
  return (
    <div className={styles.container}>
      ...
      <main>
        ...
        />
        <SecondSection
          SecondSectionData={DSAPuneData [0].secondSection}
        />
        {/* <Testimonial
          redirectDS={false}
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              DomainHead3={DSAPuneData [0].DomainHead3}
              ...
              CertificationHead1={
                DSAPuneData [0].CertificationHead1
              }
              CertificationBot1={
                DSAPuneData [0].CertificationBot1
              }
              ...
              SyllabusBotlist11={
                DSAPuneData [0].SyllabusBotlist11
              }
              SyllabusBotlist12={
                DSAPuneData [0].SyllabusBotlist12
              }
              SyllabusBotlist13={
                DSAPuneData [0].SyllabusBotlist13
              }
              SyllabusBotlist14={
                DSAPuneData [0].SyllabusBotlist14
              }
              SyllabusBotlist15={
                DSAPuneData [0].SyllabusBotlist15
              }
              SyllabusBotlist16={
                DSAPuneData [0].SyllabusBotlist16
              }
              syllabush2={DSAPuneData [0].syllabush2}
              syllabusb2={DSAPuneData [0].syllabusb2}
              SyllabusBotlist21={
                DSAPuneData [0].SyllabusBotlist21
              }
              SyllabusBotlist22={
                DSAPuneData [0].SyllabusBotlist22
              }
              SyllabusBotlist23={
                DSAPuneData [0].SyllabusBotlist23
              }
              SyllabusBotlist24={
                DSAPuneData [0].SyllabusBotlist24
              }
              SyllabusBotlist25={
                DSAPuneData [0].SyllabusBotlist25
              }
              SyllabusBotlist26={
                DSAPuneData [0].SyllabusBotlist26
              }
              syllabush3={DSAPuneData [0].syllabush3}
              syllabusb3={DSAPuneData [0].syllabusb3}
              SyllabusBotlist31={
                DSAPuneData [0].SyllabusBotlist31
              }
              SyllabusBotlist32={
                DSAPuneData [0].SyllabusBotlist32
              }
              SyllabusBotlist33={
                DSAPuneData [0].SyllabusBotlist33
              }
              SyllabusBotlist34={
                DSAPuneData [0].SyllabusBotlist34
              }
              SyllabusBotlist35={
                DSAPuneData [0].SyllabusBotlist35
              }
              SyllabusBotlist36={
                DSAPuneData [0].SyllabusBotlist36
              }
              syllabush4={DSAPuneData [0].syllabush4}
              syllabusb4={DSAPuneData [0].syllabusb4}
              SyllabusBotlist41={
                DSAPuneData [0].SyllabusBotlist41
              }
              SyllabusBotlist42={
                DSAPuneData [0].SyllabusBotlist42
              }
              SyllabusBotlist43={
                DSAPuneData [0].SyllabusBotlist43
              }
              SyllabusBotlist44={
                DSAPuneData [0].SyllabusBotlist44
              }
              SyllabusBotlist45={
                DSAPuneData [0].SyllabusBotlist45
              }
              SyllabusBotlist46={
                DSAPuneData [0].SyllabusBotlist46
              }

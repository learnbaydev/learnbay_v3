...
const NewDSA = ({ DSADataJson }) => {
  ...
  const pdfUrl =
    "https://brochureslearnbay.s3.ap-south-1.amazonaws.com/NewCourseBrochure/Manufacturing+%2B+Supplychain+GenAI+and+Agentic+AI+Program2025_compressed.pdf";
...
"
      ...
      <main>
        ...
        <Newheader
          ...
          brochureLinks="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/NewCourseBrochure/Manufacturing+%2B+Supplychain+GenAI+and+Agentic+AI+Program2025_compressed.pdf"
          brochurePdf={pdfUrl}
          interstedInHide={true}
        />
        <AlumniCompanies
        ...
        <SyllabusNew
          ...
          dataScience={true}
          titleCourse=""
          brochureLink="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/NewCourseBrochure/Manufacturing+%2B+Supplychain+GenAI+and+Agentic+AI+Program2025_compressed.pdf"
          brochurePdf={pdfUrl}
          buttonHide={true}
          interstedInHide={true}
          genAIIIT={true}
...
export async function getStaticProps() {
  const module = await import(
    "../Data/GenAIandAgenticAIProgramManufacturingSupplychainData2025"
  );

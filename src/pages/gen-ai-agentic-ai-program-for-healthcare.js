...
const NewDSA = ({ DSADataJson }) => {
  ...
  const pdfUrl =
    "https://brochureslearnbay.s3.ap-south-1.amazonaws.com/Healthcare+%26+Pharma+GenAI+and+Agentic+AI+Program_compressed2025.pdf";
...
"
      ...
      <main>
        ...
        <Newheader
          ...
          brochureLinks="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/Healthcare+%26+Pharma+GenAI+and+Agentic+AI+Program_compressed2025.pdf"
          brochurePdf={pdfUrl}
          interstedInHide={true}
        />
        <AlumniCompanies
        ...
        <SyllabusNew
          ...
          dataScience={true}
          titleCourse=""
          brochureLink="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/NewCourseBrochure/Healthcare+%26+Pharma+GenAI+and+Agentic+AI+Program_compressed2025.pdf"
          brochurePdf={pdfUrl}
          buttonHide={true}
          interstedInHide={true}
          genAIIIT={true}
...
export async function getStaticProps() {
  const module = await import(
    "../Data/GenAIandAgenticAIProgramHealthcareData2025"
  );

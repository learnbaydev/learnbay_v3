...
const WhyThisProgram = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/WhyThisProgram/WhyThisProgram')
);
const HowThisProgramHelpYourDomain = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/HowThisProgramHelpYourDomain/HowThisProgramHelpYourDomain')
);
const ToolsAndPlatforms = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/ToolsAndPlatforms/ToolsAndPlatforms')
);
...
const FinalProjectSection = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/FinalProjectSection/FinalProjectSection')
);
...
const CertificationsSection = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/CertificationsSection/CertificationsSection')
);

const CertificationsSectionIBM = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/CertificationSectionIBM/CertificationSectionIBM')
);

const StartupCertificateSection = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/StartupCertificateSection/StartupCertificateSection')
);

const ProgramSnapshotSection = dynamic(
  () =>
    import('@/components/AppliedAIPractitionerProgram/ProgramSnapshotSection/ProgramSnapshotSection')
);
      ...
      data: [
        {
          ...
          ans: 'Course fee is ₹ 1,20,000 + 18% GST. ',
          open: true,
        },
        {
          id: 1,

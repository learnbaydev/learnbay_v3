...
function Blockchain({ DataScienceCourseDataJson }) {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Learners can join us to have reliable career assistance until they land promising roles. We focus on providing industry-aligned career support services that include – Resume optimization, Interview prep, Career counseling, Endless job calls from top MNCs."
      }
    },
    {
      "@type": "Question",

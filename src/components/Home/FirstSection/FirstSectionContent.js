...
import { GreenTag } from "@/Data/svgData/Greentag";
    ...
    <section className={styles.conteiner}>
      <div className={styles.gridConteiner}>
        <div className={styles.leftside}>
          <h1 title=" India’s #1 Project-based Upskilling Platform for Professionals">
       ...
       loading="lazy"
          ...
          <button className={styles.btn} onClick={popupShow} title="Apply for Counselling">

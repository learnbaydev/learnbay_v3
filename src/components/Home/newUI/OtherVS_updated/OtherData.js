...
export const otherData = {
  ...
  leftSide: [
    { label: "Access to Live Classes" },
    { label: "Class Type", svgWidth: 100, svgHeight: 16 },
    { label: "Domain Specializations", svgWidth: 120, svgHeight: 16 },
    { label: "Project Certificates", svgWidth: 130, svgHeight: 16 },
    { label: "Learning Mode", svgWidth: 140, svgHeight: 16 },
    { label: "Project Mentorship", svgWidth: 140, svgHeight: 16 },
  ],
  middleSide: [
    "3-Year Flexi Pass",
    "Live, Mentor-Led, Interactive",
    "BFSI, Healthcare, Supply Chain, Manufacturing, HR, Project Management",
    "Issued by Industry Partners",

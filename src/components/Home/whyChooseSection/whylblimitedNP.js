...
// import whyChooseData from "./WhylbdatalimitedNP"; // Import the data

// function AnimationNew1({ fullstack }) {
...
// export default AnimationNew1;

import React, { useEffect, useRef } from "react";
import styles from "./whyChooseSection.module.css";
import Image from "next/image";
import whyChooseData from "./WhylbdatalimitedNP";
                ...
                {index === 2 ? (
                  <div className={styles.customSection}>
                    ...
                    <div>
                      <Image
                        src={item.certification.imgSrc}
                        alt={item.certification.imgAlt || "Certification"}
                        width={150}
                        height={50}
                        loading="lazy"
                        style={{ marginLeft: "16px" }}
                  ...
                  >
                    {item.subItems.map((subItem, subIndex) => (
                      <div
                        ...
                        key={subIndex}
                      >
                        {/* CONDITIONAL: Only render Image if an icon exists in the data */}
                        {subItem.icon && (
                          <Image
                            src={subItem.icon}
                            alt="icon"

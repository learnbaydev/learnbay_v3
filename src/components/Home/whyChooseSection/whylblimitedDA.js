...
// import whyChooseData from "./WhylbdatalimitedDA"; // Import the data

// function AnimationNew4({ fullstack }) {
...
// export default AnimationNew4;

import React, { useEffect, useRef } from "react";
import styles from "./whyChooseSection.module.css";
import Image from "next/image";
import whyChooseData from "./WhylbdatalimitedDA";

function AnimationNew4() {
  const divRefs = useRef([]);
                  ...
                  >
                    {item.subItems.map((subItem, subIndex) => (
                      <div
                        ...
                        key={subIndex}
                      >
                        {/* THE FIX: Only render Image if subItem.icon is defined */}
                        {subItem.icon && (
                          <Image
                            src={subItem.icon}
                            alt="icon"

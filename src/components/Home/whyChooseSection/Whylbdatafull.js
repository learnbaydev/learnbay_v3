const whyChooseData = [
    ...
    subItems: [
      {
        ...
        alt: '3D video camera icon representing 100% live instructor-led online classes for Learnbay’s data science certification programs.',
        text: '100% Live online classes',
        width: '50',
        height: '50',
      },
      {
        icon: 'https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/org_container+(1).webp',
        alt: 'An icon of live chat bubble with location pin symbol at the center representing Learnbay’s hybrid project option.',
  ...
  },
  {
    ...
    subItems: [
      ...
      { text: 'REAL EXPERIENCES' },
    ],
  },
  {
    image:
      'https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/green_light+(1).webp',
    title: 'Get Certified in Generative AI',
    description:
      'Hands-on exposure to industry-relevant projectHands-on exposure to industry-relevant projects using IBM Watsonx and leading Generative AI tools',
    certification: {
      text: 'Get GenAI Certification from:',
      imgSrc:
        'https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/IBM_+(1).webp',
      imgAlt: 'IBM',
    },
  },
  {

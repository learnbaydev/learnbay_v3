...
// import whyChooseData from "./WhylbdatalimitedSA"; // Import the data

// function AnimationNew2({ fullstack }) {
...
// export default AnimationNew2;

import React, { useEffect, useRef } from "react";
import styles from "./whyChooseSection.module.css";
import Image from "next/image";
import whyChooseData from "./WhylbdatalimitedSA";
                  ...
                  >
                    {item.subItems.map((subItem, subIndex) => (
                      <div
                        ...
                        key={subIndex}
                      >
                        {/* CONDITIONAL RENDERING: Only show icon if it exists in data */}
                        {subItem.icon && (
                          <Image
                            src={subItem.icon}
                            alt="icon"

...
//     title: "Get Industry-Certified as a System Administrator",
//     description:
//       "Hands-on exposure to industry-relevant infrastructure, cloud, and automation projects using enterprise-grade tools.",
//     certification: {
...
const whyChooseData = [
  ...
  },
  {
    ...
    description:
      "Gain hands-on experience with real-world projects, preparing you to tackle industry challenges confidently.",
    subItems: [
      { text: "REAL PROJECTS" }, // Text only
      { text: "REAL EXPERIENCES" }, // Text only
    ],
  },
  {
    image:

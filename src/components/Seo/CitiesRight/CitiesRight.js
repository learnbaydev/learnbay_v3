      ...
      <div id="Program">
        ...
        {cityTextDSmumbai ? (
          <div className={styles.CitiesRightInner}>
            ...
            <h2 className={styles.pHead}>
              Data Science and Gen AI Program in Mumbai Master Program with
            ...
            <ul>
              ...
              <h3 className={styles.pHead}>
                Highlights of the Data Science and Gen AI Program in Mumbai{' '}
              </h3>
              <li>
        ...
        {cityTextDSPune ? (
          <div className={styles.CitiesRightInner}>
            <p>
              ...
              Learnbay’s <b> Data Science Course in Pune</b> is tailored to meet
              your needs. It’s good to deeply understand a subject to get a
              rewarding career.
            </p>
            <p>
        ...
        {DSKochi ? (
          <div className={styles.CitiesRightInner}>
            <h4 style={{ fontSize: '20px' }}>
              About Learnbay’s Data Science Institute in Pune
            </h4>
            <p>
              ...
              upskilling from the best data science institute in Pune is useful
            ...
            <p>
              ...
              GenAI and Agentic AI.Our data science course in Pune paves the way
              for abstract and practical learning of the latest Gen AI-rich
            ...
            <ul>
              ...
              <li>
                ...
                data science training in Pune to refine prior domain skills.
              </li>
              ...
              <br />
              <li>
                <b>BYOP:</b> Learnbay data science course in Pune is highly
        ...
        {cityText ? (
          <div className={styles.CitiesRightInner}>
            ...
            <p>
              ...
              <br />
              <b> Note:</b>
              This is a draft module. Our modules keep changing as per the
              trending job market demand. For the latest and updated Syllebus,
              check the brochure in the detailed Module Section. (link to the
              module section)
            </p>
            <h3 className={styles.pHead}>
              Term 2 - Statistics and Machine Learning
            ...
            <h3 className={styles.pHead}>
              Data Science and Gen AI Program in Bangalore for Managers and
              Leaders
            </h3>
            <ol type="1">
              <li>Consists of 400+ hours of live sessions </li>
            ...
            <p>
              ...
              <b>INR 1,20,000</b> to <b>INR 1,59,000</b> according to your

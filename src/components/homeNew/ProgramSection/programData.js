...
export const programCards = [
  ...
  },
  {
    ...
    description:
      "Master Cloud Engineering & Automate DevOps Pipelines with GenAI to Land Top Cloud Roles",
    why: [
      "Deploy Scalable Cloud Applications",
      "Automate Infrastructure with CI/CD Pipelines",
    ],
    keySkills: ["ChatGPT", "GitOps", "Jenkins", "DevSecOps"],
    duration: " 10 Months Live Classes",
    level: "12+ Real Domain Projects",
  ...
  },
  {
    ...
    keySkills: ["PowerBI", "Tableau", "SQL & Excel"],
    duration: " 10+ Months Live Classes",
    level: "12+ Real-Time Projects",

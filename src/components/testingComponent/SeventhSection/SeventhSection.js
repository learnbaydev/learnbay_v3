  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const handleMediaChange = (e) =>
        setMobile((prev) => (prev !== e.matches ? e.matches : prev));
      ...
      <div className={styles.LearnSupport}>
        ...
        <div className={styles.learnInner}>
          ...
          <div className={styles.btnWrap}>
            ...
            <a
              href={`tel:${fullStackCont ? '+919731135221' : '+917795687988'}`}
              aria-label="Call us"
            >
              <Button
                text={fullStackCont ? '+91 97311 35221' : '+917795687988'}
                passIcon={<MdCall />}
                outline
                invert
              />
...
export default React.memo(
  SeventhSectionCopy,
  (prevProps, nextProps) => prevProps.fullStackCont === nextProps.fullStackCont
);

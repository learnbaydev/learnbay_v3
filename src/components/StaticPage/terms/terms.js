...
function terms() {
  return (
    <section className={styles.terms}>
        ...
        <p className={styles.top}>The following Terms and Conditions should be read carefully before using our website/LMS. By just viewing the site, you agree to all of the Terms and Conditions on this page.
</p>
...
<p className={styles.bot}>Before submitting the form, kindly read our privacy statement which would provide you with a better understanding.</p>

<p className={styles.top}>Please read these Terms and Conditions very carefully, before start using our website/LMS.</p>

<p className={styles.bot}>The Learnbay website is an educational service network made available through the website and contents or products that are maintained, operated, and owned by Learnbay. The website, content, and products, are under the ownership of Learnbay only.</p>
...
<p className={styles.bot}>Any user with access to the internet can avail our free services. But, we are not responsible for the charges during usage of software, internet, hardware, or any other services. The user is solely responsible for internet connection and computer hardware functionality.</p>

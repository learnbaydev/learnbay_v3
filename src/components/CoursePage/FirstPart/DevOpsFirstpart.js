...
const FirstPart = ({ SecondSectionData, S3RightImage, adsHide }) => {
  ...
  const clouddevops = {
    ...
    image1:
      'https://d32and0ii3b8oy.cloudfront.net/web/s3_main/cloud-computing/devops-logo-docker.webp',
    points: [
    ...
    <>
      ...
      {adsHide ? (
        ...
        <SecondNavbar
          // interstedInHide={true}
          dataScience={true}
          brochureLink="https://www.learnbay.co/cloud&devops/cloud-computing-and-devOps-certification-program"
          brochurePdf={pdfUrl}

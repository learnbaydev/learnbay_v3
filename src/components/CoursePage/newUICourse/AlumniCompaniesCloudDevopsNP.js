...
const AlumniCompaniesCloudDevopsNP = ({
  titleCourse,
  brochureLink,
  dataScience,
  interstedInHide,
  ...
  return (
    <section className={styles.container}>
      ...
      <h2 className={styles.heading}>
        Our alumni are working across{" "}
        <span className={styles.highlight}>350+</span> Companies worldwide{" "}
...
export default AlumniCompaniesCloudDevopsNP;

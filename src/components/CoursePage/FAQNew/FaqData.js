...
export const CertificationFaqData1 = [
  {
    id: 0,
...
export const MentorshipFaqData1 = [
  {
    id: 0,
...
export const DomainFaqData2 = [
  ...
  },
  {
    id: 1,
    ques: "What are the available elective domain options?",
    ans: "HR, Marketing, & sales; Retail, e-commerce & supply chain; Healthcare, pharma & clinical research; Banking, finance & Insurance domain; Manufacturing, mechanical & telecom domain; Media, hospitality & transportation domain; Energy, oil & gas domain.",
    open: false,
  },
  {
    id: 2,
    ques: "Why is domain specialization important?",
    ans: `After enrolling in the Advance Data Science and AI Program with Domain Specialization course, one must opt for domain electives. It is essential to have business/industry knowledge which is useful in feature engineering and modeling. Prior knowledge of the industry and domain aids in the development of more precise and accurate predictive models based on the dataset’s attributes. Furthermore, the model will be more observable in real-world situations.`,
    open: false,
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    ques: "Can I select multiple domain electives and do I need to pay extra charges?",
    ans: "You can select only up to 2 domain electives based on your interest and career goals. No, you don’t need to pay any extra charges as domain electives and capstone projects are part of our curriculum.",
    open: false,
  },
  {
    id: 5,
...
export const CertificationFaqData2 = [
  {
    id: 0,
    ques: "Is there any accredited certification after course completion?",
...
export const MentorshipFaqData2 = [
  {
    id: 0,
...
export const FaqData3 = [
  {
    id: 0,
    ques: "What are the prerequisites for the Artificial Intelligence and Machine Learning Program with Domain Specialization?",
...
export const PaymentFaqData3 = [
  ...
  {
    id: 1,
    ques: "Can I pay in installments for 1,10,000 + 18% GST?" /*1,15,000/-  check for price*/,
...
export const CertificationFaqData3 = [
  {
    id: 0,
    ques: "Is there any accredited certification after course completion?",
...
export const MentorshipFaqData3 = [
  {
    id: 0,
    ques: "Until when will the Learnbay students get the facility of mentorship?",
...
export const CertificationFaqData4 = [
  {
    id: 0,
    ques: "Is there any accredited certification after course completion?",
...
export const MentorshipFaqData4 = [
  {
    id: 0,
    ques: "Until when will the Learnbay students get the facility of mentorship?",
...
export const CertificationFaqData5 = [
  {
    id: 0,
    ques: "Is there any accredited certification after course completion?",
    ans: "Yes, you will be awarded IBM accredited Data Science and AI Certificate on successful course completion.",
    open: true,
  },
];
export const jobFaqData5 = [
  {
    id: 0,
    ques: "What’s the eligibility for a job assistance program at Learnbay?",
...
export const CertificationFaqData6 = [
  {
    id: 0,
    ques: "Is there any accredited certification after course completion?",
...
export const MentorshipFaqData6 = [
  {
    id: 0,
    ques: "Until when will the students get the facility of mentorship?",
...
export const MentorshipFaqData7 = [
  {
    id: 0,
    ques: "Until when will the students get the facility of mentorship?",
...
// for the content of dsa page add one more questiion
export const FaqDataMoreDevops = [
  {
    id: 0,
    ques: "What are the prerequisites for the Software Development Program with Specialization in Cloud Computing & DevOps?",
    ans: "  Nothing but basic coding knowledge is required to start with this course.",
...
export const DomainFaqDataDevops = [
  {
    id: 0,
    ques: "What is domain specialization?",
    ans: "We offer five elite domains, from which you can choose your preferred one for your respective specialization. Based on your targeted job role, you can choose a specific elective.",
...
export const PaymentFaqDataDevops = [
  {
    id: 0,
...
export const CapstoneFaqDataDevops = [
  {
    id: 0,
    ques: "How many real-time projects will be there?",
    ans: "We have a set of 12 real-time projects from multiple domains.",
...
export const MentorshipFaqDataDevops = [
  {
    id: 0,
    ques: "Until when will the students get the facility of mentorship?  ",
    ans: "Our Mentors will provide advanced software development training and career insights/guidance to the students until the completion of the course depending on the specialization. Post completion, students can reach out to specialized mentors for project and placement purposes.",
...
export const SupportFaqDataDevops = [
  {
    id: 0,
    ques: "When is the job assistance provided at Learnbay?",
    ans: "At Learnbay, after the course is over, placement Assistance is offered. It consists of interview preparation workshops, mock interviews, and recommendations from leading MNCs and startups. Unless a person is placed in a corporation, this service will be offered.",

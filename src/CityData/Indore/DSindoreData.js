export const DSinodreCourseData = [
  {
    secondSection: [
      {
        id: 1,
    ...
    faq: [
      {
        ...
        data: [
          ...
          },
          {
            ...
            ans: `We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Indore with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility.               `,
            open: false,
          },
          {
            id: 3,
            ques: "Do you offer flexibility in scheduling for working professionals?              ",
            ans: "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Indore.               ",
            open: false,
          },
        ],
      },
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            ...
            ans: `Learnbay offers flexible financing options for paying data science course fees in Indore. You can opt for no-cost EMI, installments, or interest-free loans to pay the fee within 12 months. 
          ...
          },
          {
            ...
            ansAfter:
              " enrolling. The policy mentions that learners can withdraw their data science fees in Indore.           ",
            link: true,
            open: false,
          },
        ],
    ...
    DomainBot1:
      "Today's digital markets demand insightful ways to conquer success amidst triggering industry rivalries. The digital space in Indore is changing rapidly due to data-driven inventions aided by the government. Thus, the demand for skilled data experts is growing every year. ",
    DomainBot2:
      "Establishing domain-specific upskilling is an effective way to succeed in developing professional competition. The varied economic structure of the city makes room for particular subject-matter expertise. For this reason, at Learnbay, we provide in-depth expertise and data science training in Indore.",
    DomainBot3:
    ...
    DomainBot40:
      "Data Science course fees in Indore can join our institute to boost their skills and achieve invincible career success. Enrolling in our job support program requires at least six months of work experience (full-time/part-time).",
    ...
    ModuleBot1:
      "The data science institute in Indore offers incredible data science courses that can help you upskill your technical knowledge. Their extensive course covers the complete data science lifecycle, including data collection, exploration, transformation, feature engineering, predictive modeling, and more. With online classes, mentorship from industry experts, and live projects to make you a perfect corporate fit.",
    ...
    Joblist4: "Dashboard vision and design with facts",
    ...
    Joblist12: "Hands-on learning of deployment (AWS & Azure) ",
    Joblist13: "Real case studies in your domain",
    Joblist14: "Practical exposure to real-world business issues via projects",

    JobBot001:
      "Data science course with placement in Indore ensures career-driven skills for cracking premium jobs with the leading global MNCs. Experts get 24/7 career support to build technical, soft, and behavioral skills.",
    JobBot002:
      "Plus, technical and soft skills offer an excellent chance to refine personalized skills and improve corporate alignment.",
    JobHead19: "Career Service Pro    ",

    JobBot20:
      "Enrolling in a data science course can lead to a promising future with lucrative pay packages for data experts. Hence, working pros choose the best data science course in Indore with 100% placement support.",
    JobBot003:
      "Our data science course training offers in-depth training and ensures end-to-end growth scopes. You are eligible for placement with personalized career support if you achieve at least 70% in tasks and projects. Here, you also earn a chance for 1:1 doubt-clearing and resume-building sessions.",
    JobBot39: "Career Service Pro feature provides –",
    Joblist14: "Hassle-free job support services for three years",
    Joblist15:
      "Six 1:1 mock interviews fixed with any of the 450+ MNCs (partners)",
    ...
    JobHead001:
      "Does Learnbay offer the most comprehensive data science course in Indore the most comprehensive, and is it worth pursuing?",
    JobBotMasterBot5:
      "Indore's digital economy benefits from data science, which enriches business yields. The city is witnessing an increasing demand for data analytics and trend-aware analytics. Thus, it becomes vital to upskill with the newest instruments and trends. ",
    JobBot007:
    ...
    JobBot005:
      "In addition, we offer an accredited big data course in Indore, endorsed by IBM and MS. Our 450+ industry partners will help you crack product/service-based jobs with leading MNCs. ",
    JobBot006: " ",
    JobHead22:
    ...
    ProjectsBot4:
      "Indore's best data science course provides comprehensive training for better job prospects. Get a hands-on learning experience. Here, you will earn a hands-on learning experience for high career openings.",
    ProjectsBot5:
      "More significantly, you'll engage in capstone projects with industry expertise to make critical skills for a competitive job. Such domains are BFSI, HR, Marketing, Healthcare, Supply Chain, and Manufacturing. This will help you stand out in a slow-paced career and lock in advanced growth options.",
    ProjectsBot6:

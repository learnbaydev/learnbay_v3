export const FScanadaCourseData = [
  {
    // script1: {
        ...
        data: [
          {
            ...
            ans: `Yes, you will be awarded with one IBM Gen AI Certificate, One Azure AI Certificate by Microsoft, and an AI Col-ab Project Certificate. `,
            open: true,
          },
        ],
      },
    ...
    ProgramBot1:
      'Tech aspirants in Canada can enroll in the job-ready full-stack developer course from Learnbay. Our 360° full-stack stack developer course in Canada provides full-fledged, industry-paced training with domain specialization. Candidates who aspire to become expert full-stack software developers can choose the domain they want to be experts in.',
    ProgramBot2:
      "Learnbay's full stack developer course in Canada holds the amazing feature of live online classes. Full stack experts with 8+ years of MNC working experience are the architect of our full stack software developer course in Canada.",
    ProgramBot3:
    ...
    ProgramHead4:
      "What do learners get from Learnbay's Full Stack Developer course in Canada?",
    ProgramBot4:
      "Learnbay's 360° full stack software developer course is conducted by a flock of full stack software developer experts working around Canada for more than 8 years. Our course has a Q&A forum for students to clear all their doubts and queries. Apart from that, students can connect with their instructor for 1-on-1 discussion on request. Self-paced learning via recorded video is not available, but a student can alter their live batches at any time as per their convenience based on learning topics. ",
    ProgramBot5:
      'There are basic coding classes for professionals from non-tech backgrounds so that they can learn with the same speed as their techie classmates.There are basic coding classes for professionals from non-tech backgrounds so that they can learn with the same speed as their techie classmates.',
    ProgramBot6:
      "We even have career counseling experts for students; they analyze a student's profile on their academic achievements and prior work experience. They suggest to candidates the best domain that suits their profile.",
    ProgramHead7:
      'Why is Learnbay the best full-stack developer course in Canada?',
    ProgramBot8:
    ...
    ProgramBot9:
      "Learnbay's full-stack developer course with domain specialization offers candidates 3 years of flexible LMS access to complete the course.",
    ...
    DomainBot1:
      'Our full-stack software developer course is a specialized domain course. Most of the top organizations search for candidates with domain-specific knowledge. Students can be an expert in a particular domain even before recruitment.',
    DomainHead2:
    ...
    ModuleBot1:
      'Our full-stack software developer course trainers are experts and IT professionals with years of experience.',
    ...
    JobBot1:
      'Our full-stack software developer course will even help students in resume building. So they can showcase the skills they have learned and excel in after completing a full stack software developer course from Learnbay in Canada.',
    JobBot3:
      'We have a specially dedicated team for students to offer them job referrals from top organizations and MNCs. So, our alumni are pre-trained for interviews and jobs they have always wanted to work for.',
    ProjectsBot1:
      'Our full-stack developer course with domain specialization offers a real-world capstone project. So our students can learn with real-world examples. This will enable students to learn and practice their skills and tools.',
    ProjectsBot2:

export const AIcanadaCourseData = [
  {
    script1: {
    ...
    script3: {
      ...
      location: [
        ...
        {
          "@type": "Place",
          name: "Learnbay - Data Science, artificial intelligence Course Training in canada",
          address: {
            "@type": "PostalAddress",
            streetAddress:
    ...
    script4: {
      ...
      supply: {
        "@type": "HowToSupply",
        name: "We provide Advanced data science course in Canada, Bangalore, Pune, Chennai, Hyderabad, Mumbai, Dubai",
      },
      tool: {
        "@type": "HowToTool",
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: "What are the prerequisites for these AI training Courses in Canada?",
          ...
          {
            id: 3,
            ques: "What is a Flexi Subscription in these advanced artificial intelligence courses in Canada?",
          ...
          {
            id: 5,
            ques: "What is the learning mode of Artificial Intelligence Certification courses in Canada at Learnbay?",
            ans: "We provide both classroom and online AI training modes. Based on your requirement, you can choose your preferred mode.",
            open: false,
          },
          {
            id: 6,
            ques: "How can I opt for a Hybrid mode of learning in IBM artificial intelligence training courses in Canada, At Learnbay? ",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What is domain specialization in the professional AI certification courses provided by Learnbay in Canada?",
          ...
          {
            id: 1,
            ques: "What are the available elective domain options in the different artificial intelligence training courses of Learnbay in Canada?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: " Is there any scholarship/discount available for these Artificial intelligence training courses available in Canada? What is Group Discount?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: " How many real-time projects/case studies will be covered in these artificial intelligence certification courses in Canada?",
          ...
          {
            id: 2,
            ques: "How will the projects be executed in Canada?",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay artificial intelligence training courses in Canada?",
    ...
    ProgramHead1:
      "What is the Domain- specialized Artificial Intelligence course in Canada?",
    ProgramBot1:
    ...
    ProgramHead3:
      "Why should you choose Learnbay for your artificial intelligence career?",
    ProgramBot3:
      "Learnbay’s mission is to provide a world-class education to AI and data science aspirants across Canada. The instructors train and share their experiences through live interactive classes. In addition, they are available to answer your queries during doubt clearing sessions. Interestingly, the modules of the IBM artificial intelligence course are affordable and flexible with the option of zero cost EMI, making it the best artificial Intelligence course in Canada. Our IBM Artificial intelligence Course provides an orientation to the theoretical and practical knowledge in using and implementing AI algorithms.",
    ProgramBot66:
      "With world-class education and cutting-edge research, we help you to become an AI expert in your chosen field.",
    ProgramHead4:
    ...
    DomainBot2:
      "Moreover, applicants with domain expertise are more likely to be considered for the AI and ML positions. This is why you should opt for domain-specific AI certification courses.",
    ...
    JobBot4:
      "As you can see, the world of AI and Machine Learning is growing exponentially every single year, creating a number of opportunities for you to learn and get work on the latest and most significant projects in many IT enterprises.",
    JobBot6:
      "There are numerous career opportunities available to you, including AI engineer, Data scientist,  Machine Learning Engineer, Robotics engineer, and more.",
    ...
    Projectsp3:
      "Amazon has made a goal to identify the most successful consumer electronic products. For these, they require live customer review analysis. You can participate in the assisting project of customer insight regeneration from the ongoing and existing reviews via a",
    ...
    AlumniBot1:
      "Learnbay has trained several enthusiastic learners to secure their careers in artificial Intelligence. It has placement assurance for students and has already placed over 1000+ learners in prestigious companies like IBM, MindTree, Accenture, and other Canadian companies.",

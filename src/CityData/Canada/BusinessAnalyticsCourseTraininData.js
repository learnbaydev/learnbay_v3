export const BAcanadaCourseData = [
  {
    script1: {
      ...
      description:
        "Business Analytics Course in Canada. Learnbay is Advanced Business Analytics Course Training Institute in Canada. Business Analytics course in Canada will enhance your career",
      image:
    ...
    script3: {
      ...
      description:
        "Learnbay offers a Data Science course in canada, the most comprehensive Data Science course in the market, covering the complete Data Science lifecycle.",
      image:
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Business Analytics Training Course in Canada?",
            ans: `There are no prerequisites for this Business Analytics certification course in Canada as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
    ...
    ProgramHead1:
      "What is the  Professional Business Analytics Certification program offered by Learnbay in Canada?",
    ProgramBot1:
      "Learnbay is one of the most prestigious institutes offering Business Analytics (BA) certification courses in Canada. This BA course is geared toward students who have a background in mathematics, strong analytical and interpretive skills, and are keen on solving business problems. The Business analytics course modules have been thoughtfully designed by experienced professionals to adhere to the latest industry trends and standards. Learnbay trainers are experts in developing business analyst enthusiasts and assisting them in getting placed in top-tier organizations around Canada. They also conduct 1-on-1 doubt clearing sessions for effective learning.",
    ProgramBot2:
      "Indeed, our IBM Business Analytics course will prepare future BA professionals on data-driven methods to make better business decisions in the areas of marketing and Sales, Finance, and others.",
    ProgramBot3:
      "Course deliverables involve 200 hours of live sessions, presentations, case study discussions, and multiple real-world projects that will help you stay ahead in the game and keep growing. Overall, Learnbay serves as a one-stop place for business analyst aspirants seeking solid knowledge and hands-on experience with various business analytics concepts.",
    ProgramHead4:
      "What will you get out of this Business Analytics course by Learnbay?",
    ProgramBot4:
      "Through Learnbay’s business analytics course, you'll master the essential quantitative and statistical skills needed to compete in today's data-driven business world.",
    ProgramBot5:
      "The outcome of the business analytics course in Canada is a business problem analysis and solution prototype. A self-study approach has been adopted in this course to become a pro-business analyst.",
    ProgramBot6:
      "The best part about Learnbay is that class schedules are both affordable and flexible, making it simple to switch between batches and trainers at any time.",
    ProgramBot8:
      "Flexi subscriptions are yet another feature that provides you with limitless access to Learnbay's LMS. This enables learners to halt and continue studies in their own comfort.",
    ProgramBot9:
      "Here, trainers make use of project-based learning to develop students' skills in problem-solving and professional communication. The business analytics course training provides a balanced education between business principles and IT methods so that students can effectively communicate with both management and technical teams within their organizations.",
    ProgramBot10:
      "Know more about Learnbay’s Business Analytics Course in Canada.",
    ...
    ModuleBot3:
      "As a part of our business analytics curriculum, a series of fundamental programming in python and R are held for non-technical aspirants. Thus, applicants from all backgrounds are encouraged to apply for this course.",
    ModuleHead3: "BA Module:",
    ModuleBot4:
      "Our cutting-edge business analytics course training is well suited to the needs of today's business executives. A course that meets the demands of the marketplace by introducing students to concepts in business analysis, database design, data warehousing, business intelligence, data visualization tools, and methods.",
    ModuleBot41:
      "In this course, you will also learn how to use powerful analytics and Business Intelligence tools such as SAS, R, and Tableau to gain a competitive advantage in the business technology industry.",
    ...
    JobBot3:
      "Business analytics is the term for the use of data analysis and statistical methods to help make business decisions. A typical business analyst needs to analyze and manage data for business decision-making. The main objective of a business analyst is to detect areas of opportunity and risk, as well as identify and quantify the sources of these areas, to improve overall business performance. They must be familiar with the company’s workflow.",
    JobBot4:
    ...
    JobBot6:
      "In our business analytics course, students will be trained to convert data into actionable insights to provide a competitive edge to organizations across Canada.",
    ProjectsBot1:
      "Learnbay has a great initiative of cloud lab features that enables students to access and learn via live business analytics projects of MNCs.",
    ProjectsBot2:

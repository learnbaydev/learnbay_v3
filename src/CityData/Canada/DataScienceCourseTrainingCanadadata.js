export const DataSciencecanadaCourseData = [
  {
    script1: {
      ...
      description:
        "Data science course in Canada. Learnbay is Advanced Data Science Course Training Institute in Canada. Data science course in Canada will enhance your career",
      image:
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 5,
            ques: "What is the mode of data science training in Canada at Learnbay?",
          ...
          {
            id: 6,
            ques: "How can I opt for a Hybrid mode of learning in IBM data science training courses in Canada, At Learnbay? ",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What is domain specialization in the professional data science certification courses provided by Learnbay in Canada?",
          ...
          {
            id: 1,
            ques: "What are the available elective domain options in the different data science training courses of Learnbay in Canada?",
        ...
        data: [
          {
            ...
            ans: `The total course fee for the 
                ...
                Advance Data Science and AI Certification course is 1,10,000/- inclusive of GST.
          ...
          {
            id: 2,
            ques: " Is there any scholarship/discount available for these Data Science training courses available in Canada? What is Group Discount?",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay Data science training courses in Canada?",
    ...
    DomainBot2:
      "Learnbay delivers domain-specialized  Data Science Training. Based on your experience, you can select the following domains:",
    DomainList1: "• BFSI",
    ...
    CertificationBot2:
      "You can earn 1 to 8 certificates depending on your course. To learn more about micro-skills certificates, refer to the respective course brochures.",
    src33:
    ...
    JobBot2:
      "Placement drives are aided by our collaboration with major tech corporations. We have partnered with globally renowned companies such as Accenture, EY, Salesforce, etc. Over 1000+ alums have been placed in various data science roles within short timeframes.",
    JobBot5:
      "Learnbay also offers a data science and AI course that comes with a placement assistance. You may be entitled to a refund of your data science course fees if you are unable to secure a data science job within six months of completing your training.",
    JobHead2: "What is the scope of Data scientists in Canada?",
    JobBot3:
      "The demand for data scientists is exploding – not just in Canada but worldwide.",
    JobBot4:

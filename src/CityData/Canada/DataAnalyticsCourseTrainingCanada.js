export const DAcanadaCourseData = [
  {
    script1: {
      ...
      description:
        "Data Analytics Course in Canada. Learnbay is Advanced Data Analytics Course Training Institute in Canada. Data Analytics course in Canada will enhance your career",
      image:
    ...
    script3: {
      ...
      description:
        "Learnbay offers a Data analytics course in canada, the most comprehensive Data analytics course in the market, covering the complete Data Science lifecycle.",
      image:
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Data Analytics Training Course in Canada?",
            ans: `There are no prerequisites for this Data Analytics certification course in Canada as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 2,
            ques: "What is a Flexi Subscription in the Data Analytics Certification Program in Canada?",
          ...
          {
            id: 5,
            ques: "How can I opt for a Hybrid mode of learning in Canada?",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What is domain specialization associated with the Learnbay machine learning certification course in Canada?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: "Is there any scholarship/discount available for the Data Analytics Certification in Canada? What is Group Discount?",
    ...
    ProgramHead1:
      "Industrial Data Analytics Program for Working Professionals Of Any Domain",
    ProgramBot1:
    ...
    ProgramBot31:
      "This Data Science training course will take you from zero to hero, where you'll also learn how to harness the power of data and turn it into actionable solutions. You'll be able to analyze data from a variety of sources, create meaningful visualizations and dashboards, and interpret the information within existing and newly implemented business models.",
    ProgramBot32:
      "Know more about the Learnbay’s Data Analytics Certification Program in Canada",
    CertificationHead1:
      " What is the certification process for the Data Analytics course at Learnbay?",
    CertificationBot1:
    ...
    CertificationBot2:
      "This IBM certification will help you keep one step ahead of the others and grab the attention of hiring Managers. We also have partnered with global tech giants to promote the abilities of our data analytics students.",
    src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/BA-DA.jpeg",
    ...
    JobBot1:
      "Learnbay’s Job assistance program is what makes it the best data analytics institute in Canada, where students will receive support with resume preparation and soft skill training workshops.",
    JobBot2:
      "Most specifically, students will be trained through mock interviews with multiple hiring Managers, allowing them to improve themselves and be ready to face the real interviews with a maximum level of confidence. Our solid partnerships with MNCs and IBM have helped many students get placed in leading multinational companies in Canada.",
    JobHead2: "How fulfilling is a career in data analytics in Canada?",
    JobBot3:
      " A Data analyst is a trained analytical thinker who is skilled in working with large data sets to bring insight and solutions. A  typical data analyst is expected to have a diverse knowledge of various tools and methods. They must be well-versed in the practical applications of algorithms. They must also be able to apply their knowledge in real-world situations.",
    JobBot4:
      "In Canada, there are several Data Analyst positions available in industries such as banking, healthcare, finance, and many others. Canadian firms are looking for candidates who can analyze complex data and discover new insights for their products.",
    JobBot6:
      "After completing the data analytics course with placement, students will be hired as data analysts by the top Canadian companies with an attractive salary package.",
    ...
    ProjectsBot2:
      "During this IBM data analytics course, you'll work on 5 famous data analytics projects, including Fake news detection and web scraping. Take a peek at some of the popular projects completed by our students:",

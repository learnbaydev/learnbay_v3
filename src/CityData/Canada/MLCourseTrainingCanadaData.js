export const MLcanadaCourseData = [
  {
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are the prerequisites for the Machine Learning course with Domain Specialization in Canada?',
          ...
          {
            id: 2,
            ques: 'What is a Flexi Subscription in the Machine learning certification course of Learnbay in Canada?',
          ...
          {
            id: 4,
            ques: 'What is the mode of ML training at Learnbay, in Canada?',
        ...
        data: [
          {
            ...
            ans: `The total program fee for the Artificial Intelligence and Machine Learning Program is INR1,59,000/- Inclusive of GST.`,
            open: true,
          },
          {
            id: 1,
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'Is there any accredited certification after this machine learning course completion in Canada?',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'Until when will the Learnbay students in Canada get the facility of mentorship? ',
    ...
    ProgramBot1:
      'Learnbay is focused on providing the best Machine Learning course training for ML practitioners with a varied selection of domain electives in Canada. It focuses on theoretical and practical approaches for machine learning enthusiasts.',
    ProgramBot2:
      'The incredible part of this machine learning course in Canada is giving customizable modules with multiple domain options, including marketing, banking, cloud computing, DevOps, etc. This course is intended for professionals with little or no prior experience in machine learning and set out to provide a gentle yet thorough industrial introduction to the field.',
    ProgramBot3:

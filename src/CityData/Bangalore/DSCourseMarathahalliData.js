export const DSMarathCourseData = [
  {
    ...
    MasterJobBot1:
      "Which soft and technical skills can you develop with Marathahalli the best data science course on Learnbay? ",
    ...
    JobHead001:
      "Is the Data Science training Marathahalli offered by Learnbay the most comprehensive, and is it worth pursuing?",
    JobBotMasterBot5:
    ...
    ProjectsBot5:
      "Learnbay’s practical upskilling strategy enables experts globally with 360-degree career-building methods. Moreover, an IBM project certificate enriches your career worth, opening doors to improved job prospects and notable career advances.      ",

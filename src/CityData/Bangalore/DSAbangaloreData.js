export const DSABangaloreCourseData = [
  {
    secondSection: [
      {
        id: 1,
    ...
    DomainBot1:
      'Today’s evolving tech era inspires working professionals to update their skills and match industry trends. Hence, the demand for upskilling via an industry-focused program keeps increasing. Learnbay’s DSA courses in Bangalore offer domain-specific training sessions to help you grab exciting opportunities. ',
    DomainBot2: '',
    DomainBot3:

export const DABangaloreCourseData = [
  {
    ...
    script4: {
      ...
      supply: {
        '@type': 'HowToSupply',
        name: 'We provide data analytics course training in bangalore',
      },
      tool: {
        '@type': 'HowToTool',
    ...
    faq: [
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is domain specialization associated with the Learnbay data analytics certification course in Bangalore?',
            ans: 'We offer industry-specific full-stack data analytics course modules, via which you learn the respective industry’s best practices.',
            open: true,
          },
          {
            id: 1,

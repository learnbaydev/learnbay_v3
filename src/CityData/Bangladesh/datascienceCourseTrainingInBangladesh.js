export const DSBangladeshCourseData = [
  {
    secondSection: [
      {
        id: 1,
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: "What are the prerequisites for these Data Science training Courses in Bangladesh?",
          ...
          {
            id: 3,
            ques: "What is a Flexi Subscription in these advanced data science courses in Bangladesh?",
          ...
          {
            id: 5,
            ques: "What is the mode of data science training in Bangladesh at Learnbay?",
          ...
          {
            id: 6,
            ques: "How can I opt for a Hybrid mode of learning in IBM data science training courses in Bangladesh, At Learnbay? ",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What is domain specialization in the professional data science certification courses provided by Learnbay in Bangladesh?",
          ...
          {
            id: 1,
            ques: "What are the available elective domain options in the different data science training courses of Learnbay in Bangladesh?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: "Can I pay in installments for these Data Science Certification courses in Bangladesh?",
          ...
          {
            id: 2,
            ques: " Is there any scholarship/discount available for these Data Science training courses available in Bangladesh? What is Group Discount?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: "How will the projects be executed in Bangladesh?",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay Data science training courses in Bangladesh?",
          ...
          {
            id: 1,
            ques: "How long will I get support for job assistance at Learnbay in Bangladesh?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: "Can a Learnbay student in Bangladesh choose to study from their desired mentor?",
    ...
    DomainBot1:
      "The fast-paced rise of digitization shows a heavy reliance on automated and data-driven tools. MNCs across Bangladesh and overseas are developing domain-specific job roles to lessen the work burden and optimize yields. Unlike earlier times, today’s job market demands skilled data scientists in respective domains.        ",
    DomainBot2:
      "Learnbay’s data science course in Bangladesh offers custom-fit training to improve your domain skills. Learners get exposure to real cases of business issues and remedial ways. So, as per your career goals and interests, you can any domain from the following –      ",
    DomainBot3: "",
    DomainList1: "• BFSI",
    DomainList2: "• HR",
    ...
    Modulelist1:
      "Basic knowledge of applied mathematics and statistical functions       ",
    Modulelist2: "Basics of Excel and Dashboard creation with data sets    ",
    Modulelist3: "DSA and Programming languages (Python, R, SQL)    ",
    Modulelist4: "Data visualization (Power BI, Tableau)    ",
    Modulelist5: "Machine learning, Deep Learning & NLP techniques    ",

    Modulelist6: "Generative AI tools & trends    ",
    Modulelist7: "AWS & MS Azure and Hands-on learning projects     ",
    ...
    Joblist1: "Data-driven skills      ",
    Joblist2: "Coding efficiency       ",
    Joblist3: "Proven skills in Python programming for data analysis       ",
    Joblist4: "Dashboard designing skills      ",
    Joblist5: "SQL techniques     ",
    Joblist6: "Statistical analysis       ",
    Joblist7: "Exploratory data analysis      ",
    Joblist8: "Deep learning & NLP for handling complex data sets       ",
    Joblist9: "Generative AI skills       ",
    Joblist10:
    ...
    JobHead23:
      "What are the career roles that you can unlock with our data science course?       ",
    Joblist18: "Data Analyst      ",
    Joblist19: "Data and Process Analyst      ",
    Joblist20: "Business Analyst      ",
    Joblist21: "Data Scientist         ",
    Joblist24: "Data Scientist Engineer      ",
    Joblist22: "Python Engineer (AI/ML)        ",
    Joblist23: "Data Engineer",
    Joblist24: "Graph Data Engineer       ",
    Joblist25: "Azure Data Engineer      ",
    Joblist26: "Business Intelligence Developer     ",
    Joblist27: "ML/AI Engineer      ",
    Joblist28: "Database Manager      ",
    Joblist29: "Data Warehouse Engineer and Data Architect      ",
    Joblist30: "Machine Learning Engineer and ML Contributor     ",
    ...
    JobBot25:
      " Experts enrolling in Learnbay’s Data Science and AI course will unlock potential career growth options at every level. These roles have multiple levels (entry – seniority) that you can crack with your current skill sets and experience.         ",
    JobSpan1:
      "Note: Experts enrolling for Learnbay’s master’s degree program in Data Science and AI have more chances to unlock managerial positions in these roles.   ",
    ProjectsHead1:
      "How do live projects help in developing invincible skills development?         ",

    ProjectsBot1:
      "Bangladesh is one of the fastest-growing countries with heavy reliance on data. A massive growth of data science in the country spreads across vital sectors, uplifting their yields. Thus, MNCs in Bangladesh urge to have skilled data scientists embarking on competitive success.         ",
    ProjectsBot3:
      "Skills upgrades have become a prime way to ensure data-driven career success with leading MNCs in Bangladesh. Learnbay’s data science course in Bangladesh ensures 360-degree upskilling to thrive in today’s era. We offer you practical learning space with live projects in your chosen domain.         ",
    ProjectsBot4:
      "Live projects help experts gain practical insights into business issues and learn better ways to combat them. Our data science online course in Bangladesh consists of live projects in the trending domains. Such domains are – BFSI, HR, Marketing, Healthcare, Supply Chain, and Manufacturing.         ",
    ProjectsBot5:
    ...
    alt1: "data science course training in Bangladesh",
    alt2: "data science course training in Bangladesh",
    alt3: "data science course training in Bangladesh",
    alt4: "data science course training in Bangladesh",
    alt5: "data science course training in Bangladesh",
    alt6: "data science course training in Bangladesh",
    alt7: "data science course training in Bangladesh",
    alt8: "data science course training in Bangladesh",

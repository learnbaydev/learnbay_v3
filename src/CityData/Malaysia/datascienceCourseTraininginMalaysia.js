export const DSMalaysiaCourseData = [
  {
    ...
    DomainBot2:
      ' A domain-specific upskilling is effective in facing career competition and attaining success. The diverse economy in the country sets a space for specific domain knowledge and skills. Thus, we at Learnbay focus on an extensive data science training program in your domain of expertise.       ',
    DomainBot3:
      'So, experts can choose any domain as per their interests –       ',
    DomainList1: '• BFSI',
    DomainList2: '• HR',
    ...
    Modulelist5: 'Dashboard design with insights         ',
    ...
    ModuleBot46:
      'Our data science course gives access to infinite career growth options with leading MNCs. One can crack high-paying jobs in their locations, preferences, and interests.       ',
    ModuleBot47:
      'Plus, experts can work with live projects and case studies to gain job readiness. It enhances domain knowledge and boosts earning potential on a global scale. Right upskilling enhances productivity and equips it with essential skills to thrive.   ',
    ModuleBot47:
      'Unlike generic courses, Learnbay envisions a rewarding career for data experts with improved skills and confidence.   ',
    ...
    JobBot001:
      'Our data science programs help you gain job-oriented skills to crack interviews with top-tier global MNCs. Experts get 24/7 career support here to help them acquire technical, soft, and behavioural skills.   ',
    JobBot002:
      'Apart from technical and soft skills, we also focus on building your behaviour to become a good organizational fit. Real-world case studies help experts learn how an industry operates and develop ways of tackling them.    ',
    ...
    JobBot003:
      'Our data science training in Malaysia offers end-to-end job and placement support via Career Service Pro. You are eligible for placement service once you achieve at least 70% in tasks and assessments. You will get everything – from 1:1 doubt-clearing to resume review.       ',
    ...
    JobHead001:
      'Does Learnbay provide the best data science course in Malaysia? Is it worth it?       ',
    JobBotMasterBot5:
      'Malaysia’s digital economy sees data science as a fueling factor, enriching business yields exponentially. Meanwhile, the country has an increasing demand for data scientists with knowledge of the latest trends. Thus, many working pros opt for upskilling with the latest tools and trends. ',
    JobBot007:
      'Our data science program in Malaysia combines GenAI-rich training with top tools and techniques. Our open learning space helps you acquire in-demand skills and ace data science jobs.       ',
    JobBot005:

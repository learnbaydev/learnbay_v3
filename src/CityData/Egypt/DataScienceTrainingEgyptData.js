export const DSEgyptCourseData = [
  {
    secondSection: [
      {
        id: 1,
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are Data Science Training courses available at Learnbay in Egypt?',
          ...
          {
            id: 3,
            ques: 'What is a Flexi Subscription in these advanced data science courses in Egypt?',
          ...
          {
            id: 5,
            ques: 'What is the mode of data science training in Egypt at Learnbay?',
          ...
          {
            id: 6,
            ques: 'How can I opt for a Hybrid mode of learning in IBM data science training courses in Egypt, At Learnbay? ',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is domain specialization in the professional data science certification courses provided by Learnbay in Egypt?',
          ...
          {
            id: 1,
            ques: 'What are the available elective domain options in the different data science training courses of Learnbay in Egypt?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'Can I pay in installments for these Data Science Certification courses in Egypt?',
          ...
          {
            id: 2,
            ques: ' Is there any scholarship/discount available for these Data Science training courses available in Egypt? What is Group Discount?',
...
`,
          ...
          {
            id: 1,
            ques: 'How will the projects be executed in Egypt?',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay Data science training courses in Egypt?",
          ...
          {
            id: 1,
            ques: 'How long will I get support for job assistance at Learnbay in Egypt?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'Can a Learnbay student in Egypt choose to study from their desired mentor?',
    ...
    DomainBot1:
      'Our comprehensive data science courses in Egypt offer domain-specific training. You can enroll in our courses and choose any domain elective from the following –        ',
    DomainBot2: '  ',
    DomainBot3: '    ',
    DomainList1: '• BFSI',
    DomainList2: '• HR',
    ...
    CertificationBot2:
      'A data science certificate unlocks global-scale career success with attractive hikes and swift promotions. Here you will get –        ',
    CertificationBot3: ' ',
    CertificationBot4:
    ...
    Modulelist1: 'Basics of Statistical analysis and functions         ',
    Modulelist2: 'Basic and advanced MS Excel      ',
    Modulelist3: 'Coding with Programming languages (Python, SQL)        ',
    Modulelist4: 'Big data tools      ',
    Modulelist5: 'Data visualization tools (Power BI, Tableau)      ',

    Modulelist6: 'Data structures and algorithms (DSA)      ',
    Modulelist7:
      'Machine learning algorithms & techniques, NLP, deep learning models        ',
    Modulelist8: 'GenAI trends      ',
    Modulelist9: 'Deployment and Evaluation (AWS & Azure)      ',
    Modulelist10: 'Capstone project and Case studies       ',
    ModuleBot46: '      ',
    ModuleBot47: '  ',
    ModuleBot47: '  ',
    ...
    JobHead1: 'Listing Out Job-Ready Skills that You Will Develop        ',
    Joblist1: 'Insightful data analysis with complex data sets      ',
    Joblist2: 'Coding expertise         ',
    Joblist3: 'Data manipulation       ',
    Joblist4: 'Dashboard creation and analysis (Power BI & Tableau)      ',
    Joblist5: 'Big data analytics      ',
    Joblist6: 'Data visualization         ',
    Joblist7: 'Machine learning tools and uses      ',
    Joblist8: 'GenAI-rich expertise         ',
    Joblist9: 'Hands-on learning via real-time projects       ',
    Joblist10: ' Decoding complex data         ',
    Joblist11: ' Deep learning      ',
    Joblist12: ' AI and ML algorithms      ',
    Joblist13: ' Data exploration      ',
    JobBot001: ' ',
    JobBot002: ' ',
    JobHead19: 'Career Service PRO (100% Job and Placement Support)  ',

    JobBot20:
      'Working pros eager to re-establish their careers with assured success, opt for upskilling. Upskilling via data science certificate programs equips learners with premium job offers globally. Learners with a score of 70% are eligible to avail of our 100% job and placement program.         ',
    JobBot003:
    ...
    JobHead30: 'Is Learnbay the Best Institute for Data Science?       ',

    JobBot21:
      'Egypt is one of several developing countries moving towards a data-driven culture. Since 2019, the country has started recognizing data science as the future of their businesses and job market outlook. Yet, a huge skill gap exists in the country. Thus, many working pros are moving toward upskilling with data science courses.         ',
    JobHeadEgypt01: '        ',
    JobBot22:
    ...
    ProjectsHead1:
      'Are the real-time projects from Learnbay beneficial for career growth?         ',

    ProjectsBot1:
      'At Learnbay, we believe in industry-driven upskilling to help you ace competitive careers in data science. Our data science course in Egypt offers 12+ real-time projects in trending domains. Our projects cover the domain fields like –  BFSI, Healthcare, Manufacturing, HR, Supply Chain, and Marketing.         ',
    ProjectsBot3:
      'Industry experts guide our learners with their project-related queries and prepare them for top-tier interviews. With our project, you can learn about real-world data issues and ways to handle them. Plus, learners obtain an IBM project certificate that validates their valuable skills as per current industry standards.         ',
    ProjectsBot4: '   ',
    ProjectsBot5: '      ',
    ...
    alt1: 'data science course training in Egypt',
    alt2: 'data science course training in Egypt',
    alt3: 'data science course training in Egypt',
    alt4: 'data science course training in Egypt',
    alt5: 'data science course training in Egypt',
    alt6: 'data science course training in Egypt',
    alt7: 'data science course training in Egypt',
    alt8: 'data science course training in Egypt',
    alt9: 'data science course training in Egypt',
  },
];

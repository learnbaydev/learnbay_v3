export const DAMumbaiCourseData = [
  {
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Data Analytics Training Course in Mumbai?",
            ans: `There are no prerequisites for this Data Analytics certification course in Mumbai as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 2,
            ques: "What is a Flexi Subscription in the Data Analytics Certification Course in Mumbai?",
          ...
          {
            id: 5,
            ques: "How can I opt for a Hybrid mode of learning in Mumbai?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: "Is there any scholarship/discount available for the Data Analytics Certification in Mumbai? What is Group Discount?",
    ...
    ProgramBot1:
      "Learnbay is one of the leading data analytics training institutes in Mumbai, with a diverse selection of professional programs. Learnbay's objective is to deliver individualized data analytics training so that everyone can easily deal with the complex real-world analytical requirements. In fact, this is why at Learnbay, you get most of the modules as practical assignments rather than boring theoretical sessions.",
    ProgramBot2:
      "We dedicatedly address personalized career needs. Accordingly, provides data analytics projects options. So, instead of holding just a data Analytics Certificate, you hold the ultimate abilities to be a successful data analyst in MNCs. It offers an immersive data analytics learning experience in Mumbai with one-on-one doubt clearing sessions conducted by renowned industry professionals. This distinguishes it as a one-stop-shop for everyone interested in becoming a truly professional data analyst. ",
    ProgramHead3:
      "How does it become a truly professional Data Analytics course in Mumbai?",
    ProgramBot3:
      "This is a data analytics course with Placement Support (dedicated). The associated industrial data analytics training in Mumbai by Learnbay not only offers full-stack data analytics modules but also ensures you get a job after competing in the same. Its hands-on learning methodology incorporates interactive sessions with leading data analysts and industry projects to cover in-depth topics like exploratory data analysis, data visualization, and regression techniques.",
    ProgramHead4:
      "Why is Learnbay the top data analytics training Provider in Mumbai?",
    ProgramBot4:
      "It’s mainly because of two reasons. One is their industrial recognition via IBM collaboration and the second one is their project exposure. At Learnbay, you get the ultimate industrial experience, even before joining your first data analyst job role. Due to an extremely personalized learning experience via 24 hours tech support, on-demand 1-on-1 discussion, and FANNG expert as an instructor,  the data analytics training program in Mumbai become the best option to enroll. In addition, within the data analytics course fees you pay, you get 1-years flexible subscription to this data analytics program. This helps you maintain your professional responsibilities and the learning progress at the same time with the greatest ease.",
    ProgramBot5:
      "Know more about the Industrial Data Analytics Program in Mumbai by Learnbay",
    ...
    ModuleBot1:
      "Lack of programming knowledge is no more a barrier to data analytics courses for working professionals in Mumbai. A series of dedicated basic python and R programming classes are there. So, candidates with any professional background (Marketing, Finance, HR, etc.) can enroll.",
    ...
    JobBot1:
      "Learnbay is dedicated to providing the most comprehensive data analytics training in Mumbai.",
    JobBot2:
      "We provide specialized mock interviews for candidates looking for jobs in data analytics as part of our job aid program. We also assist students with résumé writing, technical skills training, and soft skill development. Our strong links with MNCs and IBM have aided numerous students in obtaining positions in the top leading organizations in the shortest period possible. After completing the course, approximately 700+ Learnbay students have already achieved lucrative roles in worldwide corporate giants such as Amazon, TCS, EY, JP Morgan, and Mercedes.",
    JobHead2: "Why Earning the Data Analytics Skills Is So Important?",
    JobBot3:
      "The Simplest answer is to secure your career. Data analysis is used to forecast and understand precise business results. Learners of  IBM data analytics training course in Mumbai become eligible to make better business decisions. Descriptive, prescriptive, and automated data analytics are three types of data analytics. Significant differences exist between the three, which may be taught in-depth through our data analytics course. Until you have an adequate degree of analytical understanding, the job opportunities will start narrowing in the upcoming years.",
    JobHead3:
      "What Are the Data Analytics Roles in Mumbai You Can Target After This Course?",
    JobBot4:
      "At the end of Learnbay provided  IBM data analytics Certification, you can apply for the following positions:",
    JobBot6:
      "Junior Data Analyst, Marketing Analyst,Data Analytics consultant,Financial Analyst, HR Analyst, Quantitative Analyst, Operation Analyst, etc.",
    ProjectsBot1:
      "The premium cloud lab element of the IBM data analytics course from Learnbay is one of its best features available in Mumbai. There are a total of 5 live MNC project opportunities, which you can access through this cloud lab. All of these projects are as per the data analytics skill demand spread across Mumbai City.  Below are a few of the data Analytics projects, already done by Learnbay students in Mumbai. ",
    ...
    CityTextB:
      "Data Analytics Course Certification Training locations in Mumbai ",
    CityText:

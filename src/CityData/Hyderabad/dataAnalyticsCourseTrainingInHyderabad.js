export const DataAnalyticsHyderabadCourseData = [
  {
    script1: {
      ...
      description:
        "You just have to follow 3 easy steps to enroll in our advanced Data Analytics course",
      image:
    ...
    script2: {
      ...
      description:
        "Data Analytics Course in Hyderabad. Learnbay is the Best Data Analytics Courses Training Institute in Hyderabad with guarantied Job Assistance. Data Analytics course Certification will improve skills",
      image:
        "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/home-page-header.webp",
      author: {
        "@type": "Organization",
    ...
    script3: {
      ...
      mainEntity: [
        ...
        {
          "@type": "Question",
          name: "What’s the duration of the Data Analytics Course in Hyderabad?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "What is the mode of Data Analytics training at Learnbay, Hyderabad?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    script4: {
      ...
      description:
        "Learnbay offers a Data Analytics course in Hyderabad, the most comprehensive Data Analytics course in the market, covering the complete Data Analytics lifecycle.",
      image:
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Data Analytics Training Course in Hyderabad?",
            ans: `There are no prerequisites for this Data Analytics certification course in Hyderabad as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
    ...
    But if you could not attend more classes, you can opt for batch change and join the next batch. `,
          ...
          {
            id: 2,
            ques: "What is a Flexi Subscription in the Data Analytics Certification Program in Hyderabad?",
    ...
    Saturday & Sunday - 3.5 hours/day`,
          ...
          {
            id: 5,
            ques: "How can I opt for a Hybrid mode of learning in Hyderabad?",
    ...
    No, you don’t need to pay any extra charges as domain electives and capstone projects are part of our curriculum.`,
...

      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: "Is there any scholarship/discount available for the Data Analytics Certification in Hyderabad? What is Group Discount?",
   ...
   Worked and successfully completed the minimum recommended number of real-time projects.`,
    ...
    ModuleBot2:
      "Countless working professionals have benefited from our data analytics course training in Hyderabad by improving their technical abilities and gaining expertise in various fields.",
    ModuleBot3:
      "The IBM data analytics course's modules cover all of the important topics in data analytics tools and methodologies, such as data pretreatment, data exploration, statistical analysis, dashboarding, PowerBI, SQL, etc.",
    ...
    CityTextB:
      "Data Analytics Course Certification Training locations in Hyderabad ",
    CityText:

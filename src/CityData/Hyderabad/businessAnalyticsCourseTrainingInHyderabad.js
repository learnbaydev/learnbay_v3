export const BusinessAnalyticsHyderabadCourseData = [
  {
    script1: {
      ...
      description:
        "You just have to follow 3 easy steps to enroll in our advanced Business Analytics course",
      image:
    ...
    script2: {
      ...
      description:
        "Business Analytics Course in Hyderabad. Learnbay is the Best Business Analytics Courses Training Institute in Hyderabad with guarantied Job Assistance. Business Analytics course Certification will improve skills",
      image:
        "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/home-page-header.webp",
      author: {
        "@type": "Organization",
    ...
    script4: {
      ...
      description:
        "Learnbay offers a Business Analytics course in Hyderabad, the most comprehensive Business Analytics course in the market, covering the complete Business Analytics lifecycle.",
      image:
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Business Analytics Training Course in Hyderabad?",
            ans: `There are no prerequisites for this Business Analytics certification course in Hyderabad as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
   ...
   Worked and successfully completed the minimum recommended number of real-time projects.`,
    ...
    ModuleBot1:
      "The 200-hour business analytics training in Hyderabad includes live interactive classes from PRODUCT Based Companies professionals. Students can also talk to mentors one-on-one about their concerns in the discussion forum and via scheduled meetings.",
    ModuleBot2:
    ...
    ModuleBot3:
      "Non-programmers can take fundamental Python programming classes and learn the language from the basics. As a result, people from all walks of industry are welcomed to apply for the Learnbay IBM business analytics course.",
    ...
    JobBot5:
      "A business analyst's job is to lead a group of people in making important decisions regarding the company's future. A business analyst's decisions influence the performance of a company. They must be familiar with the company's workflow. Their primary responsibilities include analyzing corporate logistics and proposing innovative methods. The demand for business analysts and BI professionals in Hyderabad has surged due to many new organizations and businesses springing up all across the city and the country.",
    ProjectsBot1:
      "Projects are an excellent approach to sharpen specific skills, particularly in business analytics. Learnbay offers a distinctive cloud lab feature that allows you to access and work on real-time data analytics projects. All of these initiatives are based on the most in-demand business analytics expertise in Hyderabad.",
    ProjectsBot2:
      "As part of this business analytics training in Hyderabad, you will have the opportunity to work on five real-world industry projects. Our students have previously worked on a variety of domain projects, which are highlighted below.",
    ...
    CityTextB:
      "Business Analytics Course Certification Training locations in Hyderabad ",
    CityText:

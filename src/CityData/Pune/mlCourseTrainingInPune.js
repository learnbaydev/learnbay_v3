export const MLPuneCourseData = [
  {
    ...
    //   supply: {
    //     '@type': 'HowToSupply',
    //     name: 'We provide machine learning course training in pune',
    //   },
    //   tool: {
    //     '@type': 'HowToTool',
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are the prerequisites for the Machine Learning course with Domain Specialization in Pune?',
          ...
          {
            id: 2,
            ques: 'What is a Flexi Subscription in the Machine learning certification course of Learnbay in Pune?',
          ...
          {
            id: 4,
            ques: 'What is the mode of ML training at Learnbay, in Pune?',
        ...
        data: [
          {
            ...
            ans: `Yes, you will be awarded 4 separate certifications for successful course completion of the Machine learning and Gen AI course in Pune . Two IBM certificates within which one will be IBM Gen AI, Course, others will be from Microsoft and Learnbay. You get project experience certificate too.`,
            open: true,
          },
          {
            id: 1,
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'Until when will the Learnbay students in Pune get the facility of mentorship? ',
    ...
    JobBot1:
      'The Learnbay Machine Learning course in Pune consists of an end-to-end job assistance program. It helps students create their resumes and project portfolios, so recruiters highlight their profiles.',
    JobBot2:

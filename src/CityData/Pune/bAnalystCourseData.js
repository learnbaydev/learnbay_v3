export const BAnalystPuneCourseData = [
  {
    script1: {
    ...
    ProgramBot4:
      "At Learnbay, we believe in the importance of hands-on training in the form of capstone and real-world projects. Besides, the business analysis course in Pune also offers domain electives.",

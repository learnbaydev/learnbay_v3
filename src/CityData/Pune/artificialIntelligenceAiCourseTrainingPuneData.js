export const AIPuneCourseData = [
  {
    ...
    //   description:
    //     'Artificial Intelligence Course in Pune. Learnbay is Advanced Artificial Intelligence Course Training Institute in Pune. Artificial Intelligence course in Pune will enhance your career.',
    //   image:
    ...
    //   '@type': 'EducationEvent',
    //   name: 'Artificial Intelligence (AI) Course Training in Pune',
    //   description:
    //     'Artificial Intelligence Course in Pune. Learnbay is Advanced Artificial Intelligence Course Training Institute in Pune. Artificial Intelligence course in Pune will enhance your career.',
    //   image:
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'What are the prerequisites for these AI training Courses in Pune?',
          ...
          {
            id: 3,
            ques: 'What is a Flexi Subscription in these advanced artificial intelligence courses in Pune?',
          ...
          {
            id: 5,
            ques: 'What is the learning mode of Artificial Intelligence Certification courses in Pune at Learnbay?',
            ans: 'We provide both classroom and online AI training modes. Based on your requirement, you can choose your preferred mode.',
            open: false,
          },
          {
            id: 6,
            ques: 'How can I opt for a Hybrid mode of learning in IBM artificial intelligence training courses in Pune, At Learnbay? ',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is domain specialization in the professional AI certification courses provided by Learnbay in Pune?',
          ...
          {
            id: 1,
            ques: 'What are the available elective domain options in the different artificial intelligence training courses of Learnbay in Pune?',
        ...
        data: [
          {
            ...
            ans: `The total course fee for the Artificial Intelligence Training Course in Pune is 1,59,000 + 18% GST.`,
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 2,
            ques: ' Is there any scholarship/discount available for these Artificial intelligence training courses available in Pune? What is Group Discount?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: ' How many real-time projects/case studies will be covered in these artificial intelligence certification courses in Pune?',
          ...
          {
            id: 2,
            ques: 'How will the projects be executed in Pune?',
...
`,
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay artificial intelligence training courses in Pune?",
    ...
    DomainBot2:
      "Learnbay mentors and guides analyze candidates' profiles and accordingly suggest respective domains to students. Presently, recruiters are not much interested in which University certificate you hold. Rather they are madly concerned about your domain expertise. A normally certified AI expert with finance domain knowledge gets a better candidature score than a master's degree holder in AI without a finance background <b><a href='https://www.learnbay.co/blogs/master-tech-layoffs-survival-skills' target='_blank' >Master Future-Proof Skills to Survive Tech Layoff .</b></a>",
    ...
    ModuleBot2:
      'Each of the AI courses offered by Learnbay are planned with different modules as per the consented career stage of the professionals. All of the courses are equipped with properly balanced theoretical and practical sub-modules. The most important modules that Learnbay artificial intelligence course covers are SQL, Pandas, Numpy, Data visualization, NP, artificial neural network, etc. Keeping the non-programmer huddle about programming in mind, Learnbay AI courses also offer basic programming sub-modules.',
    ...
    JobBot3:
      'Business intelligence developer. Data scientist. Big Data Engineer. Artificial intelligence Engineer. Machine learning engineer. Research scientist. Robotics Scientist.',
    ProjectsBot1:
      'Artificial intelligence projects are the key to a successful AI career. Based on the artificial intelligence course you choose, you get 5 to 15 live industrial projects along with 2 to 3 capstone projects. Students are given ownership of the project to work with creativity. A capstone project adds an extra skill to your certificates and resume.',

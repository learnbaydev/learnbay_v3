export const BAPuneCourseData = [
  {
    ...
    //   description:
    //     'Business Analytics Course in Pune. Learnbay is Advanced Business Analytics Course Training Institute in Pune. Business Analytics course in Pune will enhance your career.',
    //   image:
    ...
    //     {
    //       '@type': 'Question',
    //       name: 'What are the prerequisites for the Business Analytics Training Course in Pune?',
    //       acceptedAnswer: {
    //         '@type': 'Answer',
    //         text: 'There are no prerequisites for this Business Analytics certification course in Pune as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.',
    //       },
    //     },
    //     {
    //       '@type': 'Question',
    ...
    //     {
    //       '@type': 'Question',
    //       name: 'What is a Flexi Subscription in the Business Analytics Certification course in Pune?',
    //       acceptedAnswer: {
    //         '@type': 'Answer',
    ...
    //     {
    //       '@type': 'Question',
    //       name: 'What’s the duration of the Business Analytics Program in Pune?',
    //       acceptedAnswer: {
    //         '@type': 'Answer',
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are the prerequisites for the Business Analytics Training Course in Pune?',
            ans: `There are no prerequisites for this Business Analytics certification course in Pune as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
        ...
        data: [
          {
            ...
            ans: `The total fee for the Business Analytics Program is INR 1,20,000 + 18% GST.`,
            open: true,
          },
          {
            id: 1,
    ...
    JobHead2:
      'What type of responsibility should you expert as a business analyst in Pune?',
    JobBot3:

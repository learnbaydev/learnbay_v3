export const DSAPuneData = [
    {
      script1: {
        ...
        description:
          "Data science course in Pune. Learnbay is Advanced Data Science Course Training Institute in Pune. Data science course in Pune will enhance your career",
        image:
      ...
      faq: [
        {
          ...
          data: [
            ...
            },
            {
              ...
              ans: `Learnbay believes in a flexible and open learning environment. Thus, working professionals willing to upskill themselves get the advantage of a hybrid learning mode. Data structures and algorithms course in Pune comes on weekdays (8 PM – 10 PM; Mon-Wed-Fri) and weekends (8.30 AM – 12 PM; Sat-Sun). Concerning the working schedules, learners can fix their sessions with the mentors. Learnbay offers both classrooms and virtual learning sessions. Yet, with hybrid learning, learners get the scope of working on live projects across offline experience centers.  
            ...
            {
              id: 5,
              ques: "How long does it take to complete the Data Structure Training in Pune? ",
              ans: "The DSA classes in Pune take 400+ hours or 6.5 months. During the program, learners will get live training sessions, live projects, job-readiness assistance, & interview preparations under the guidance of mentors. One can complete the course modules and projects per batch timings. ",
              open: false,
            },
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              ...
              ans: " Yes, you can change your electives anytime during the data structures and algorithms training in Pune. Based on the updated domain choice, our industry experts will guide your training sessions.  ",
              open: false,
            },
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              ...
              ans: "The learners can work with real-time industry projects and gain practical experience in their domains. Learnbay brings group project-handling sessions under the guidance of mentors and experts. For virtual learning mode, learners can work via cloud labs and online guidance from industry experts. For the hybrid training mode, learners can opt for offline DSA classes in Pune for projects. In-person meetings and doubt-clearing sessions help the learners refine their skills in real time. ",
              open: false,
            },
          ],
        },
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              ...
              ans: `The learners obtaining at least 70% in tasks and assessments become eligible for the job-readiness or job assistance program. Before this, one must have completed the training sessions, gained the required knowledge, and completed minimum tasks, assignments, and projects provided by the experts.  `,
              open: false,
            },
            {
              id: 2,
            ...
            },
            {
              ...
              ans: `When you get upskilled with the best data structures & algorithms training institute in Pune, you become eligible for its placement program. It offers -`,
        ...
        },
        {
          ...
          data: [
            ...
            {
              id: 3,
              ques: "Do counseling sessions help learners make wise decisions before enrolling in a DSA course in Pune  ",
              ans: "Learnbay offers the scope of understanding the course program and its role in shaping a bright career in a desired field. This happens through an industry-led counseling session. Our counselors help learners in upskilling with DSA concepts with practical knowledge. Before enrolling in the DSA courses in Pune, you also get the benefit of attending demo sessions by industry experts to check the quality of training and course curriculum. Thus, it helps working professionals make the right decision in a career shift. ",
              open: false,
            },
            {
              id: 4,
      ...
      DomainBot1:
        "Today’s business space accepts data dominance, leveraging key functions and profit-generating methods. Hence, experts from diverse domains prefer career upskilling to align their expertise with the rising DSA trends and practices. In the interim, DSA learning has become vital for tech and non-tech experts from diverse fields. ",
      DomainBot2:
      ...
      DomainBot3:
        ...
        DomainList1: "• Full Stack",
        DomainList2: "• Product Engineer/Manager",
        DomainList3: "• Data Science and AI",
        DomainList4: "• Web 3.0 Developer",
        DomainList5: "• DevOps & Cloud",
      CertificationBot1:
        "Working professionals joining a career-enriched DSA course in Pune will obtain IBM & Microsoft certifications for course and project work. These globally recognized credentials help specialists validate their skills and excel limitlessly. Plus, experts with these useful certificates can land profitable jobs with top-rated MNCs.",
      src33:
      ...
      ModuleBot1:
        "Learnbay’s data structure training in Pune offers an inclusively curated syllabus covering all vital concepts, tools, and practices. Our regularly updated industry-focused syllabus helps you master fundamental and advanced DSA topics. Our learning modules enrich your abilities to tackle real-world cases and drive exciting gains. ",
      ...
      syllabussrc:
        ...
        JobBot1:
          "The rapidly evolving dominance of DSA over modern business landscapes inspires IT and non-IT experts to revamp their career paths. Hence, career upskilling has become vital for experts to grab exciting offers and land promising DSA roles. Join Learnbay’s job assistance program to refine your abilities and uncover promising careers. ",
          JobBot2:
          "You can join our placement program once you complete your data structures and algorithms classes in Pune. Eligible learners with at least 70% scores in assessments and tasks can join Career Services PRO. ",
       
          JobHead2: "Career Services PRO is a placement program that guides you through the end-to-end process of cracking your dream roles. Here, you will get – ",
        JobBot3:

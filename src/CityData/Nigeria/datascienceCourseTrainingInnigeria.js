export const DSNigeriaCourseData = [
  {
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are Data Science Training courses available at Learnbay in Nigeria?',
          ...
          {
            id: 1,
            ques: 'What are the prerequisites for these Data Science training Courses in Nigeria?',
          ...
          {
            id: 3,
            ques: 'What is a Flexi Subscription in these advanced data science courses in Nigeria?',
          ...
          {
            id: 5,
            ques: 'What is the mode of data science training in Nigeria at Learnbay?',
          ...
          {
            id: 6,
            ques: 'How can I opt for a Hybrid mode of learning in IBM data science training courses in Nigeria, At Learnbay? ',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is domain specialization in the professional data science certification courses provided by Learnbay in Nigeria?',
          ...
          {
            id: 1,
            ques: 'What are the available elective domain options in the different data science training courses of Learnbay in Nigeria?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'Can I pay in installments for these Data Science Certification courses in Nigeria?',
          ...
          {
            id: 2,
            ques: ' Is there any scholarship/discount available for these Data Science training courses available in Nigeria? What is Group Discount?',
        ...
        data: [
          {
            ...
            ans: `Depending on the course you choose the number of capstone projects will vary.  
                  ...
                  How many real-time projects/case studies will be covered in these Data Science certification courses in Nigeria?
          ...
          {
            id: 1,
            ques: 'How will the projects be executed in Nigeria?',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay Data science training courses in Nigeria?",
          ...
          {
            id: 1,
            ques: 'How long will I get support for job assistance at Learnbay in Nigeria?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'Can a Learnbay student in Nigeria choose to study from their desired mentor?',
    ...
    DomainBot1:
      'Domain-specific training has become a powerful gateway to promising career growth. Learnbay’s data science course in Nigeria crafts its course syllabus following domain electives. It helps learners to redefine their career graph in their domain expertise. At Learnbay, you can choose any domain as per your career interest and start upskilling.',
    ...
    Modulelist6: 'Generative AI tools (ChatGPT)    ',
    Modulelist7: 'AWS & Azure (Deployment and Evaluation)    ',
    ...
    JobHead1:
      'Can Learnbay’s data science course in Nigeria help me develop job-driven skills?',
    JobBot1:
      'Learnbay’s live instructor-led data science classes help experts learn and develop in-demand data-driven skills. Our in-depth training sessions guide you with skill sets such as –',
    Joblist1: 'Python and libraries (NumPy, Matplotlib, Seaborn, Pandas)',
    Joblist2: 'Data analysis with Python types and flavors',
    Joblist3: 'Statistical functions',
    Joblist4: 'Data visualization of facts from complex data sets',
    Joblist5: 'Insightful dashboard designs with Tableau and Power BI',
    Joblist6:
      'Skills in KNN, SVM, decision trees, machine learning algorithms, etc',
    Joblist7: 'Database handling with proven SQL skills',
    Joblist8: 'Data-driven skills (data preprocessing, evaluation, & analysis)',
    Joblist9:
      'Dashboard design skills with fair reporting (Tableau & Power BI)',
    Joblist10: 'Deployment skills with AWS & Azure',
    Joblist11:
    ...
    JobBot20:
      'Owing to the data-driven trends, experts opt for industry-focused upskilling programs with 100% job assistance. Learnbay supports this and brings ‘Career Service Pro’ to the limelight. Eligible learners (with a minimum score of 70% in assessments) can opt for this job assist program to get –',
    Joblist14:
      'Uninterrupted job assistance for 3 years with top-tier job offers',
    Joblist15: '6 mock interviews with leading MNCs',
    Joblist16: 'Resume Building',
    Joblist17: 'LinkedIn Profile Review',

    JobHead30:
      'Is Learnbay’s data science certification in Nigeria useful to make global-level careers?',
    ...
    JobBot24:
      'Upskilling with Learnbay’s world-class data science online course supports global-scale career rise. It unlocks the door to lucrative career roles in the field of data science, such as –',

    Joblist23: 'Data Analyst and Dashboard Developer    ',
    Joblist24: 'Risk Data Analyst and Strategic BI Analyst    ',
    Joblist25: 'Data and Reporting Specialist    ',
    Joblist26: 'Data Scientist and Python Data Scientist    ',
    Joblist27: 'Data Architect and Data Engineer    ',
    Joblist28: 'AI Engineer, and ML Engineer    ',
    Joblist29: 'Data Warehouse Specialist and Database Manager    ',
    Joblist30: 'Business Intelligence Developer    ',
    Joblist31: 'ML Engineer',
    Joblist32: 'Dashboard Developer',
    Joblist33: 'Data Warehouse Specialist',
    Joblist34: 'Data Engineer',
    Joblist35: 'Database Manager',
    Joblist36: 'Business Intelligence Developer',
    JobBot25:
      'Learnbay’s data science course in Nigeria equips you with proven skills to crack job roles across leading MNCs. Enrol today and unleash your true career power to become a skillful data science professional.',
    ProjectsHead1:
      'Are Learnbay’s real-time simulation projects worth it for cracking global-level jobs?',

    ProjectsBot1:
      'Live projects help you gain exposure to real-world business cases and combat them with expertise. Learners can choose their projects based on their domain – BFSI, Marketing, Healthcare, Supply Chain, HR, and Manufacturing. You can learn data science in Nigeria in your domain to kick-start a thriving career across leading MNCs.',
    ProjectsBot3:
      'Regardless of data scientist course fees, experts step forward for skills upgrades. Learnbay’s promising data science certification in Nigeria helps you gain insights via real-time simulation/live projects.',
    ProjectsBot4:
      'Plus, we offer you IBM project certification once you complete capstone projects. It helps you build a solid portfolio with insights.',
    ...
    alt1: 'data science course training in Nigeria',
    alt2: 'data science course training in Nigeria',
    alt3: 'data science course training in Nigeria',
    alt4: 'data science course training in Nigeria',
    alt5: 'data science course training in Nigeria',
    alt6: 'data science course training in Nigeria',
    alt7: 'data science course training in Nigeria',
    alt8: 'data science course training in Nigeria',

export const AIChennaiCourseData = [
  {
    script1: {
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: "What are the prerequisites for these AI training Courses in Chennai?",
          ...
          {
            id: 3,
            ques: "What is a Flexi Subscription in these advanced artificial intelligence courses in Chennai?",
          ...
          {
            id: 5,
            ques: "What is the learning mode of Artificial Intelligence Certification courses in Chennai at Learnbay?",
            ans: "We provide both classroom and online AI training modes. Based on your requirement, you can choose your preferred mode.",
            open: false,
          },
          {
            id: 6,
            ques: "How can I opt for a Hybrid mode of learning in IBM artificial intelligence training courses in Chennai, At Learnbay? ",
...

      {
        ...
        data: [
          {
            id: 0,
            ques: "What is domain specialization in the professional AI certification courses provided by Learnbay in Chennai?",
          ...
          {
            id: 1,
            ques: "What are the available elective domain options in the different artificial intelligence training courses of Learnbay in Chennai?",
...

      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: " How many real-time projects/case studies will be covered in these artificial intelligence certification courses in Chennai?",
          ...
          {
            id: 2,
            ques: "How will the projects be executed in Chennai?",
...

      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay artificial intelligence training courses in Chennai?",
    ...
    ProgramHead1:
      "What is the Artificial intelligence course with domain specialization in Chennai?",
    ProgramBot1:
      "Learnbay is one of the leading AI training institutes in Chennai. It offers industry-recognized artificial Intelligence courses with the flexibility of choosing domain electives. This IBM artificial intelligence course is a unique combination of advanced study packages and capstone projects, making it stand out from the rest. Thus, the curriculum in the modules is up-to-date and in line with the needs of industries.",
    ProgramBot2:
      "With the assistance of capstone projects, our mentors deliver the best artificial intelligence training to students. Our artificial intelligence and data science course with placement is a fantastic initiative that has assisted countless students in obtaining excellent job opportunities across Chennai.",
    ProgramBot3:
      "In this artificial intelligence training, you’ll learn how to apply AI to real-life business problems through a balanced combination of established data science and artificial intelligence approaches along with industry-specific best practices.",
    ProgramHead4:
      "Why should you consider taking Learnbay’s IBM artificial intelligence course?",
    ProgramBot4:
    ...
    ProgramHead5:
      "Available Artificial Intelligence Certification Courses by Learnbay in Chennai:",
    ...
    CertificationBot1:
      "Our artificial intelligence course with placement comes with multiple IBM certifications on completing different modules. You will receive 1-8 certificates depending on your selection of course. Not only this, you will be awarded an IBM project experience certificate on completion of capstone projects.",
    CertificationBot2:
    ...
    ModuleBot2:
      "Each of our modules is completely dedicated to the selected domains. It covers a variety of tools and approaches, including all of the most popular AI tools, advanced probability, Numpy, Pandas, Matploitlip, Deep Learning, and MongoDB.",

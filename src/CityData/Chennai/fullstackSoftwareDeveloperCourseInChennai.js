export const FullStackChennaiCourseData = [
  {
    script1: {
    ...
    ProgramBot1:
      "The full-stack developer course at Learnbay in Chennai is for tech aspirants who want to become expert full-stack software developers. Our Full-stack developer course includes different domains for students to get expertise in a specific domain.",
    ProgramBot2:
      "Learnbay's full-stack software developer course is designed by industrial experts in different domains. Learners can stand out from other candidates by learning the latest skills required in the present tech world through Learnbay.",
    ProgramBot3:
      "Our motto is to help students find their way out of the haystacks of outdated courses. Learnbay's full-stack developer course in Chennai will enable you to grow as an expert front-end and back-end software developer in Chennai.",
    ProgramHead4:
      "What do learners get from Learnbay's Full Stack Developer course in Chennai?",
    ProgramBot4:
    ...
    ProgramHead5:
      "Our full-stack software developer course in Chennai has special classes for week programming to drag them on track.",
    ProgramBot5:
      "Our career counseling experts analyze enrolled candidates' profiles. Our career experts analyze student profiles and other academic achievements suggesting to you the best domain for your full-stack developer courses.",
    ProgramHead6:
      "How has Learnbay become a superior option as a job-ready full-stack software development course in Chennai?",
    ProgramBot6:
    ...
    ProgramHead7:
      "In fact, we arrange real-world business problem-solving hackathons and trending topic-based webinars.",
    ProgramBot8:
      "Students get the freedom to learn at their own pace and convenience. Our full stack developer online course in Chennai gives students three years of flexible subscription for completing a full stack software development course.",
    ProgramHead8:
    ...
    ModuleBot1:
      "Our trainers are expert full-stack developers holding 8+ years of industrial experience in different top-notch MNCs. Learnbay full stack developer experts have curated the course as per Chennai's organizational requirements.",
    ModuleHead2: "Become a professional MEAN and MERN stack developer.",
    ModuleBot3:
      "Learnbay Full-stack software development course in Chennai covers String, Stack, array overview, binary research, Best, average, and worst case complexities hierarchy, Complexity classes (P vs. NP problem), AVL tree, backtracking algorithm, recursion and graph, and many more trending tools.",
    syllabussrc:
    ...
    JobBot1:
      "Our Full-stack developer course in Chennai assists students in building and upgrading their resumes with all the tools and domain knowledge you honed after completing our full-stack software developer course in Chennai. Our student's dedicated team even refers to jobs of top organizations and MNCs.",
    ProjectsBot1:
      "A full stack developer course in Chennai from Learnbay includes a real-time capstone project. Students get to experience and work with real-world problems. This increases the demand for Learnbay alumni in the present job market.",
    ProjectsBot2:
      "A Capstone project is essential to your resume. Our full stack developer course in Chennai has a project innovation lab for students to work on projects under the direct guidance of industry leads.",
    ...
    AlumniBot1:
      "Till now, we have reshaped 1000+careers via Learnbay's full-stack development course online. Most of our alumni got recruited within three months after completing the course, and others in the following cycling months.",

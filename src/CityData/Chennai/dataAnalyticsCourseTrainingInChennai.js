export const DataAnalyticsChennaiCourseData = [
  {
    script1: {
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Data Analytics Training Course in Chennai?",
            ans: `There are no prerequisites for this Data Analytics certification course in Chennai as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 2,
            ques: "What is a Flexi Subscription in the Data Analytics Certification Program in Chennai?",
          ...
          {
            id: 5,
            ques: "How can I opt for a Hybrid mode of learning in Chennai?",
...

      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: "Is there any scholarship/discount available for the Data Analytics Certification in Chennai? What is Group Discount?",
    ...
    ProgramHead2:
      "What is the professional data analytics training in Learnbay?",
    ProgramBot1:
      "Learnbay is one of the best institutes for data analytics Courses in Chennai, as it offers a wide range of programs. Learnbay's mission is to provide customized data analytics training and prepare learners for the real world. It takes care of everything, from hands-on training through data analytics projects to qualify for the interviews at top leading MNCs. It provides an immersive data analytics learning experience led by top industry experts along with one-on-one doubt clearing sessions. This unique feature makes it a one-stop place for anyone wanting to become a successful data analyst.",
    ProgramBot2:
      "The Learnbay Data analytics course in Chennai has been designed to meet the ever-changing demands of the industry. This data analytics course with placement assistance is easily accessible to both experienced working professionals and early pros from any industry. Its practical learning model includes interactive sessions by superior practitioners and industry projects to provide in-depth coverage of topics like data analysis, data visualization, and regression techniques.",
    ProgramHead3:
      "Why is Learnbay the best institute for data analytics training in Chennai?",
    ProgramBot3:
      "Learnbay Provides 100%  live interactive classes with flexible hours and sessions led by experienced data analysts. Additionally, Our data analytics course in Chennai comes with a one-year Flexi subscription to the course allowing students to learn at their convenience. A unique feature is learners can choose their preferred batch and mentors. They provide additional classes for non-programmers to stay on track with other peers.",
    ProgramBot31:
      " On the other hand, With our world-class data analytics training in Chennai, students can be well-prepared to succeed in today's data-driven world. The Learnbay data analytics course with placement includes both practical and theoretical topics for a well-balanced approach to learning.",
    ProgramBot32:
      "Know more about the Learnbay Data Analytics Couse in Chennai. ",
    ...
    JobBot2:
      "Our strong ties with MNCs and IBM have helped many students get placed as data analysts in the top leading firms with a minimum possible timeline. After the course completion, approx 700+ Learnbay students have already landed high-paying positions in Amazon, TCS, EY, JP Morgan, and Oracle as Multinational corporations across Chennai. ",
    ...
    JobHead3:
      "What are career opportunities after enrolling in the IBM data analytics course in Chennai?",
    JobBot6:
      "In Chennai, data analysts are high in demand and this course will definitely help you secure your career. Below are the data analytics job roles you can apply for after the completion of our data analytics course with placement:",
    JobBot7:
      "Data Analyst, Marketing Data Analyst, Financial Analyst, Operation Analyst, Data Analytics Consultant and many more.",
    ProjectsHead1:
      "What are the types of data analytics projects associated with this course?",
    ProjectsBot1:

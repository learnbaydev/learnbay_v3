export const DataScienceChennaiCourseData = [
  {
    ...
    faq: [
...

      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: " Is there any scholarship/discount available for these Data Science training courses available in Chennai? What is Group Discount?",
    ...
    JobBot4:
      "However, there is a shortage of qualified talent that can meet the demand for data scientists in Chennai. This creates an opportunity for those who have the right skills to step up and fill this gap in the market.",
    JobBot6:

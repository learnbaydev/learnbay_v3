export const BADubaiCourseData = [
  {
    script1: {
    ...
    script2: {
      ...
      description:
        "Business Analytics Course in Dubai. Learnbay is Advanced Business Analytics Course Training Institute in Dubai. Business Analytics course in Dubai will enhance your career",
      image:
        "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/home-page-header.webp",
      author: {
        "@type": "Organization",
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: "What are the prerequisites for the Business Analytics Training Course in Dubai?",
            ans: `There are no prerequisites for this Business Analytics certification course in Dubai as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
    ...
    ModuleBot2:
      "Learnbay's business analytics course has been tailored as per the demand of the present Dubai marketplace. Each module of the BI course is built-up progressively by using a leading-edge teaching strategy. In this course, you will begin with the fundamentals of analytics before moving on to advanced industrial applications.",
    ModuleBot3:
      "Tableau, SQL, and SAS are among the powerful analytical and business intelligence (BI) tools you'll study in our professional business analytics course.",
    ...
    JobBot4:
      "In Dubai, you can apply for a variety of positions, including senior business analyst, Quantitative analyst, Business translator, Marketing Analyst, Business Intelligence analyst,  Database administrator, and many more.",
    JobBot5:
      "By taking this professional business analytics course, you will learn how to use the power of analytics to build a strong career in BI and business analytics.",
    ProjectsBot1:
      "Learnbay’s Business Analytics Certification learning experience is integrated with real-world projects to assist students in gaining real-world experience and excelling in their Business analyst careers.",
    ProjectsBot2:

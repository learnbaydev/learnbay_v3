export const DADubaiCourseData = [
  {
    ...
    //   description:
    //     'Data Analytics Course in Dubai. Learnbay is Advanced Data Analytics Course Training Institute in Dubai. Data Analytics course in Dubai will enhance your career',
    //   image:
    //     'https://d32and0ii3b8oy.cloudfront.net/web/s3_main/home-page-header.webp',
    //   author: {
    //     '@type': 'Organization',
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are the prerequisites for the Data Analytics Training Course in Dubai?',
            ans: `There are no prerequisites for this Data Analytics certification course in Dubai as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.`,
            open: true,
          },
          {
            id: 1,
    ...
    But if you could not attend more classes, you can opt for batch change and join the next batch. `,
          ...
          {
            id: 2,
            ques: 'What is a Flexi Subscription in the Data Analytics Certification Program in Dubai?',
          ...
          },
          {
            ...
            ans: `The duration of the data analytics course in Dubai is 6 months.`,
            open: false,
          },
          {
            id: 4,
          ...
          {
            id: 5,
            ques: 'How can I opt for a Hybrid mode of learning in Dubai?',
    ...
    No, you don’t need to pay any extra charges as domain electives and capstone projects are part of our curriculum.`,
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: 'Is there any scholarship/discount available for the Data Analytics Certification in Dubai? What is Group Discount?',
        ...
        data: [
          {
            ...
            ans: `Upon successful completion of the data analytics course in Dubai, you will receive 3 certifications, two from IBM and one from IIT Patna.`,
            open: true,
          },
        ],
      },
   ...
   Worked and successfully completed the minimum recommended number of real-time projects.`,
    ...
    ModuleBot2:
      "In this training, you'll also learn the core concepts of predictive analytics and see how modern Hadoop-based technologies and tools can give you a head-start in Data Analytics.",
    ModuleBot3:
      'Additionally, Learnbay also offers specialized Python programming classes for non-coders to enhance their programming skills.',
    ...
    JobBot3:
      'Data Analytics is the process of obtaining useful information from data. It helps in achieving efficiency and providing insights into a business operation.',
    JobBot4:
    ...
    JobBot7:
      'Data analytics is one of the fastest-growing career fields in Dubai. Given the current market scenario, there is always an increasing demand for Data Analysts in the workplace, and it may be an ideal career choice for people with a strong foundation in mathematics, statistics, or business backgrounds. In Dubai, a typical data analyst earns around 10,000 AED per month, which is decent pay in an expensive city.',
    JobBot8:
      'Overall, Data analytics is a great profession to be in, offering opportunities with high compensation and expert status with the right experience. Our data analytics course with placement will help you get started on this journey to becoming a professional data analyst in Dubai.',
    ProjectsBot1:
      "As part of our IBM data analytics certification, students will be given hands-on practical training under the guidance of mentors. Here, they will be required to work on 5 popular data analytics projects. Learnbay's cloud lab option provides learners with access to ongoing MNC projects, allowing them to stay up to date on the newest data analytics trends. Some of the projects of previous Learnbay students:",

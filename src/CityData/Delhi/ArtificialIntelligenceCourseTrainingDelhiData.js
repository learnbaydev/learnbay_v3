export const AIelhiCourseData = [
  {
    ...
    script3: {
      ...
      "@type": "EducationEvent",
      name: "Artificial Intelligence Course in Delhi",
      description:
        "Artificial Intelligence Course in Delhi. Learnbay is Advanced Artificial Intelligence Course Training Institute in Delhi. Artificial Intelligence course in Delhi will enhance your career",
      image:
    ...
    faq: [
        ...
        data: [
          {
            ...
            link5: "/data-science-ai-masters-program",
            link: true,
            open: true,
          },
          {
            id: 1,
            ques: "What are the prerequisites for these AI training Courses in Delhi?",
          ...
          {
            id: 3,
            ques: "What is a Flexi Subscription in these advanced artificial intelligence courses in Delhi?",
          ...
          {
            id: 5,
            ques: "What is the learning mode of Artificial Intelligence Certification courses in Delhi at Learnbay?",
            ans: "We provide both classroom and online AI training modes. Based on your requirement, you can choose your preferred mode.",
            open: false,
          },
          {
            id: 6,
            ques: "How can I opt for a Hybrid mode of learning in IBM artificial intelligence training courses in Delhi, At Learnbay? ",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What is domain specialization in the professional AI certification courses provided by Learnbay in Delhi?",
          ...
          {
            id: 1,
            ques: "What are the available elective domain options in the different artificial intelligence training courses of Learnbay in Delhi?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: " Is there any scholarship/discount available for these Artificial intelligence training courses available in Delhi? What is Group Discount?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: " How many real-time projects/case studies will be covered in these artificial intelligence certification courses in Delhi?",
          ...
          {
            id: 2,
            ques: "How will the projects be executed in Delhi?",
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay artificial intelligence training courses in Delhi?",
        ...
        data: [
          {
            ...
            ans: "Our Mentors will provide AI training to the students until the completion of the course. ",
            open: true,
          },
          {
            id: 1,
    ...
    ProgramBot1:
      "Learnbay is a top AI course training provider in Delhi. It offers industry-recognized Artificial Intelligence courses with various domain electives to pick from. Because it is a combination of advanced study packages with capstone projects, which helps these IBM Artificial Intelligence courses stand out from the crowd. ",
    ProgramBot2:
      "With live MNC and capstone projects, Learnbay mentors deliver the best Artificial Intelligence training to students. Learnbay's Artificial Intelligence courses in Delhi with placement are a fantastic effort that has assisted many students in obtaining excellent employment in and around Delhi.",
    ProgramBot3:
      "The Learnbay Artificial Intelligence course will teach you how to apply AI to real-world business difficulties using a balanced combination of existing Artificial Intelligence and Machine Learning approaches and upcoming industry-specific best practices.",
    ProgramBot66:
      "Learnbay's main purpose is to provide high-quality Artificial Intelligence and Machine Learning training to aspirants in Delhi. Domain-specific modules are carefully crafted by industry experts and will be sent to you as part of your Artificial Intelligence training. Learnbay also provides blended learning sessions as well as live question-and-answer sessions. Because the modules are reasonable and flexible, with the option of 0% interest EMI, it is the best  Artificial Intelligence (AI) course for working professionals in Delhi. This IBM Artificial Intelligence course covers everything that a student seeking the best AI course training in Delhi will need to know.",
    ...
    CertificationHead1:
      "How does the Learnbay AI certification process become unique?",
    CertificationBot1:
    ...
    ModuleBot2:
      "Our Foundation Artificial Intelligence and Machine Learning courses training have 200+ hours long modules, while the most advanced Artificial Intelligence and Machine Learning certification courses for tech professionals are 400 hours long. The entire sessions are live and interactive only. Students can attend multiple sessions with different lecturers during the training in all of our courses. Learnbay also provides a flexible membership allowing students to learn at their speed for one to three years.",
    ModuleBot3:
      "Learnbay Artificial Intelligence (AI) course training in Delhi’s every module is specific to the student's selected domain. It includes, among other things, the most popular AI tools, advanced probability, Numpy, Pandas, Matplotlib, Deep Learning, and MongoDB.",
    ModuleBot4:
      "Students with weak programming backgrounds will benefit from an additional 6-8 hours of basic programming sessions (at zero added cost) designed in the course module.",
    ...
    CityTextB:
      "Artificial Intelligence Course Certification Training locations in Delhi",
    CityText:

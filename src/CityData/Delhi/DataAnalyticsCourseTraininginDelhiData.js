export const DADelhiCourseData = [
  {
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: "What is a Flexi Subscription in the Data Analytics Certification Program in Delhi?",
          ...
          {
            id: 5,
            ques: "How can I opt for a Hybrid mode of learning in Delhi?",
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: "Is there any scholarship/discount available for the Data Analytics Certification in Delhi? What is Group Discount?",
    ...
    ProgramHead4:
      "Why should you choose the Learnbay data analytics course for your data analytics career?",
    ProgramHead5:
      "Learnbay’s Data Analytics course in Delhi is closely coupled with the needs of the industry and training by experts in the field. They also conduct query resolution sessions. The purpose of this data analytics course with placement is to provide students with theoretical and practical knowledge to get ready for the real world. Classes are highly interactive with flexible hours and sessions. Students will have access to recorded videos and a discussion forum via an automated LMS. A Flexi pass gives them access to Learnbay's LMS for one year so that they can revise data analytics concepts and work on projects. This feature also allows them to switch their mentors and batches.",
    ProgramHead6:
      "Learnbay also offers coding classes to support non-technical learners in mastering the Basics of Programming.",
    ProgramHead7:
      "Know more about the Learnbay Data Analytics Course in Delhi.",
    ...
    JobBot2:
      "Many of our students have been placed in prestigious organizations in Delhi and all over India as a consequence of our close ties with MNCs and IBM.",
    JobHead2: "The demand for data analysts in Delhi:",
    JobBot3:
      "Data Analytics is the study of extracting meaning from large data sets in order to gain useful insights. The skills and tools provided by this course will give you the knowledge, confidence, and hands-on experience to be able to go out into your organization and start making a difference.",
    JobBot4:
      "New Delhi is the leading IT city in India and the business hub of the Asia-Pacific region. Therefore, it is a major center for many offices, and thus there’s a dearth of data analysts in Delhi.",
    JobBot6:
      "Consequently, Data analytics course training in Delhi comes with lots of opportunities that offer students to develop their careers.",
    ProjectsBot1:
      "Learnbay instructors make sure that students have learned the in-demand concepts of data analytics with hands-on experience through a series of real-time projects. As part of the professional data analytics course, you will work on 5 industrial data analytics projects, including Fake news detection and color detection.",
    ProjectsBot2:
      "Aside from this, students can take advantage of our cloud lab feature to witness and learn from real-world projects from multinational corporations. Take a peek at some of the popular projects done by our students:",
    ...
    Asrc2: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/asrar-home.png",
    AlumniH2: "Mohammad Israr",
    Alumnip2:
    ...
    CityTextB:
      "Data Analytics Course Certification Training locations in Delhi ",
    CityText:

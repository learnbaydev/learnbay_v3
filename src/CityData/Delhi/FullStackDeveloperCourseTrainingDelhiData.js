export const FSDelhiCourseData = [
  {
    script1: {
    ...
    faq: [
      {
        ...
        data: [
          ...
          },
          {
            ...
            ansAfter:
              "1. Online Mode :- You can only participate in live, interactive classes online (no recorded video-based session is available). Project sessions will also be conducted online. ",
    ...
    ProgramBot1:
      "Learnbay provides the best full-stack software developer course in Delhi with domain specialization. Our full-stack developer course is a complete job-ready solution for those who are dreaming of a lucrative and ever-growing tech career. ",
    ProgramBot2:
      "Learnbays full stack developer course in Delhi enables students to learn all the latest skills of full stack software development that are in demand across the world.",
    ProgramBot3:
      "Our full-stack software developer course in Delhi is to help professionals through the right career track that leads to the ultimate peak of success. Transitioning to a career as a full-stack software developer in Delhi is not that hard anymore.",
    ProgramHead4:
      "What do learners get from Learnbay's Full Stack Developer course in Delhi?",
    ProgramBot4:
      "Instead of following the generic online learning trends, Learnbay has developed a team of instructors consisting of 70+ expert full-stack developers from top-notch MNCs and PRODUCT Based Companies. Also, they are from different domains/industries like cloud computing, data science, AI, etc.",
    ProgramBot5:
      "And such experts are the designers of Learnbay’s full-stack development course.",
    ProgramBot6:
      "The full stack developer course in Delhi by Learnbay is created and curated according to the requirement of organizations in Delhi as well as the overseas job market.  Depending on your requirement learners get custom-fit job assistance and course content.",
    ProgramBot7:
      "In facEach of our classes is live and offers additional scopes of 1 to 1student-instructor query resolution.",
    ProgramBot8:
      "In fact, during the job assistance program, we help our students with customized strategies that fit them best. Flexibility and time boundness are other features that Learnbay provides with dedication. Keeping the hardship of time management for working professionals, we offer a flexible batch selection for live classes at their convenience. However, to retain the efficacy of our full-stack developer course in Delhi, we don’t provide a self-paced receded video-based learning option.",
    ProgramHead14:
      "Why Learnbay proves to be the best full-stack software developer course in Delhi? ",
    ProgramHead15: "Live & Interactive class experience ",
    ProgramBot10:
      "The first measure that makes our full-stack software developer course in Delhi is the 100% live and interactive learning mode. Although students attend the class online but get the same efficacy as offline university classes. ",
    ...
    ProgramBot15:
      "Students can choose between weekend and weekday batches and the domain they want to become experts in.",
    ProgramHead18: "Domain Specialization",
    ProgramBot16:
      "In order to retain the weight and advantages of experienced pros, you must acquire full-stack software development skills keeping your domain requirements in focus. Learnbay offers five elite domain options to choose from. ",
    ProgramHead19: "Basic coding classes for non-tech professionals",
    ProgramBot17:
      "We also encourage the weak programmer to get into a full-stack software development career.  Our full-stack development course in Delhi offers dedicated add-on programming sessions with basic coding modules to weak programmers before they get into the core learning modules. We also encourage the weak programmer to get into a full-stack software development career.  Our full-stack development course in Delhi offers dedicated add-on programming sessions with basic coding modules to weak programmers before they get into the core learning modules. ",
    ProgramHead20: "Personalized Career Guidance",
    ProgramBot18:
      "Our expert team of career counselors analyzes enrolled candidates' profiles based on their academic achievements and prior work experience. They guide our students to a domain that matches their profile and career. In fact, they also customized the learning modules as per learners' individualistic requirements. ",
    ProgramHead8:
      "Learnbay full stack software developer course features are :",
    ...
    ModuleBot1:
      " Learnbay course trainers are full-stack developers and experienced full-stack software developers. ",
    ...
    ProjectsBot2:
      "A capstone project is a great way to show your skill on your resume. Our project innovation labs are solely dedicated to such capstone projects where students can work collaboratively with their batchmates from the same domain. ",
    ...
    AlumniBot1:
      "Almost all our alumni got emplaced within 3 months of full-stack development course completion and others in following few following months. We have to recond that 30% of our alumni got the job even before the final test associated.",
    AlumniHead1:
      "Few Our Alumni sharing their success and learning experiences:",
    ...
    CityTextB:
      "Full-Stack Software Developer Course Certification Training locations in Delhi",
    CityText:

export const DSSouthAfricaCourseData = [
  {
    secondSection: [
      {
        id: 1,
    ...
    faq: [
      {
        ...
        data: [
          ...
          {
            id: 3,
            ques: 'What is a Flexi Subscription in these advanced data science courses in South Africa?',
          ...
          {
            id: 5,
            ques: 'What is the mode of data science training in South Africa at Learnbay?',
          ...
          {
            id: 6,
            ques: 'How can I opt for a Hybrid mode of learning in IBM data science training courses in South Africa, At Learnbay? ',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is domain specialization in the professional data science certification courses provided by Learnbay in South Africa?',
          ...
          {
            id: 1,
            ques: 'What are the available elective domain options in the different data science training courses of Learnbay in South Africa?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 2,
            ques: ' Is there any scholarship/discount available for these Data Science training courses available in South Africa? What is Group Discount?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'How will the projects be executed in South Africa?',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: "What's the eligibility for a job assistance Program in Learnbay Data science training courses in South Africa?",
          ...
          {
            id: 1,
            ques: 'How long will I get support for job assistance at Learnbay in South Africa?',
      ...
      },
      {
        ...
        data: [
          ...
          {
            id: 1,
            ques: 'Can a Learnbay student in South Africa choose to study from their desired mentor?',
    ...
    DomainBot1:
      'Learnbay’s data science course in South Africa aims for a career rise with domain-specific training. Learners can select their preferred domain elective to continue with training and project tasks. We ensure your progress across cutting-edge domains such as –    ',
    DomainBot2: ' ',
    DomainBot3: '',
    DomainList1: '• BFSI',
    DomainList2: '• HR',
    ...
    ModuleHead1:
      'Knowledge Outcomes of Learnbay’s Data Science Online Course       ',

    Modulelist1: 'Basic mathematics and statistical analysis    ',
    Modulelist2:
      'Knowledge of programming languages (Python and related libraries)    ',
    Modulelist3: 'Clear visualization of data sets    ',
    Modulelist4: 'Insightful dashboard design     ',
    Modulelist5: 'Data structures and algorithms      ',

    Modulelist6: 'Generative AI: Tools and Future Trends   ',
    Modulelist7: 'AWS & Azure: Deployment & Evaluation     ',
    Modulelist8: 'Generative AI: Tools and Future Trends    ',
    ...
    JobHead1:
      'What job-specific skills can I develop via Learnbay’s data scientist courses in South Africa?       ',
    Joblist1: 'In-depth learning of data types, trends, and tools    ',
    Joblist2: 'Error-free programming with Python',
    Joblist3: 'Fair data analysis with Python types and flavors       ',
    Joblist4: 'SQL & R skills for database handling      ',
    Joblist5: 'Statistical analysis and Data Visualization   ',
    Joblist6: 'Exploratory Data Analysis    ',
    Joblist7: 'Domain-specific capstone projects    ',
    Joblist8: 'Tableau and Power BI to craft interactive dashboards    ',
    Joblist9: 'Deep learning, Machine learning algorithms & NLP skills     ',
    Joblist10: 'Business case studies for job readiness    ',
    Joblist11: 'Generative AI tools (ChatGPT)    ',
    Joblist12: 'Expertise with AWS & Azure platforms    ',
    Joblist13: 'Hands-on experience with learned tools    ',
    Joblist14: 'Business case studies for job readiness    ',

    JobHead19: 'Career Service Pro    ',

    JobBot20:
      'Working pros enroll in the best data science certification courses for its job assist program. Learnbay’s dedicated placement cell supports your career shift journey and equips you with promising job offers globally. Career Service Pro – a proven job assist program that offers –      ',
    Joblist14:
      '3 years of effortless placement support (global job offers)    ',
    Joblist15: '6 mock interviews (any of 450+ MNC partners)  ',
    Joblist16: 'Resume Build up & Optimization    ',
    Joblist17: 'LinkedIn Profiling',
    Jobspan:
      'Note: If you score at least 70% in your course tasks, you are eligible for Learnbay’s job assist program. ',
    JobHead21:
      'Is Learnbay’s data science online course in South Africa worth it?       ',
    ...
    JobBot22:
      ' Further, 24/7 doubt-clearing sessions support skills refinement to cope with today’s cut-throat career races. Our 350+ leading MNCs & unicorn startups craft a successful way toward data-driven career rise with alluring hikes. This makes us the best institute for data science aligned with industry metrics.       ',
    JobBot30:
    ...
    JobHead22:
      'What are the in-demand job roles that you can crack with our training?       ',

    Joblist23: 'Data Analyst    ',
    Joblist24: 'Data Scientist      ',
    Joblist25: 'Data Scientist Engineer    ',
    Joblist26: 'Data Engineer',
    Joblist27: 'ML/AI Engineer and Business Intelligence Developer    ',
    Joblist28: 'Database Manager and Data Warehouse Engineer    ',
    Joblist29: 'Data Architect    ',
    Joblist30: 'Big Data Analyst',

    JobBot25:
      ' With our industry-focused data science training in South Africa, you can craft your dream career in these roles with lucrative perks.       ',

    ProjectsHead1:
      'How do Learnbay’s capstone projects help you build a global-level data science career?       ',

    ProjectsBot1:
      'Data science is trending throughout South Africa. Its rapid growth encourages experts to think about a career in data science. Meanwhile, MNCs in South Africa look forward to hands-on expertise in real-world business issues. Working pros opting for Learnbay’s data science online course get practical learning with live projects.       ',
    ProjectsBot3:
    ...
    alt1: 'data science course training in South Africa',
    alt2: 'data science course training in South Africa',
    alt3: 'data science course training in South Africa',
    alt4: 'data science course training in South Africa',
    alt5: 'data science course training in South Africa',
    alt6: 'data science course training in South Africa',
    alt7: 'data science course training in South Africa',
    alt8: 'data science course training in South Africa',
    alt9: 'data science course training in South Africa',
    CityTextB:
      'Artificial Intelligence Course Certification Training locations in South Africa ',
    CityText:
      'i411021], Donje [411025], Bopkhel [411031], Bhusari Colony [411038], Haveli [411045], Jambhulwadi [411046], Lohogaon [411047], Khondhwa [411048], Anandnagar [411051], Navsahyadri [411052], Chatursringi [411053], Gokhalenagar [411055], Warje [411058], Mohamadwadi Kadvasti [411060], Janaki Nagar [411066], Aundh [411067], Pimpri Chinchwad [411078], Nanded [411230], Gondhale Nagar [412029], Sathe Nagar [412047], Alandi Devachi [412105], Ambarvet [412115], Ashtapur [412207], Manjari Farm [412307], Phursungi [412308], Viman Nagar 411014, Shaniwar Peth [413337].',
    CityTextLB: 'Locations Offered',
    CityTextL:
      ' :Artificial Intelligence Course viman nagar,Artificial Intelligence Training in kalyan nagar,Artificial Intelligence Training in magarpetta,Artificial Intelligence Training in pimpri chinchwad,Artificial Intelligence Classes in yerwada,Artificial Intelligence Classes in kharadi,Artificial Intelligence Classes in vishrantwadi,Artificial Intelligence Classes in deccan,Artificial Intelligence Course in Katraj,Artificial Intelligence Training in warje,,Artificial Intelligence Certification Training in bavdhan,Artificial Intelligence Certification in boat club road,Artificial Intelligence Certification in model colony,Best Artificial Intelligence Training in South Africa,Best Artificial Intelligence Course in South Africa',
  },
];

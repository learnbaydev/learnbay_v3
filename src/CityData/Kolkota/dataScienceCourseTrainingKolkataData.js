export const DSKolkotaCourseData = [
    {
      ...
      faq: [
        {
          ...
          data: [
            ...
            },
            {
              ...
              ans: `We provide both classroom and online instructor-led training sessions at Learnbay. You upskill with the best institute for data science in Kolkata with an industry-led course curriculum. You can opt for online or offline sessions according to your working schedules and flexibility.               `,
              open: false,
            },
            {
              id: 3,
              ques: "Do you offer flexibility in scheduling for working professionals?              ",
              ans: "Yes, we offer a flexible learning platform for working professionals in any domain to maintain a work-learn balance. Learners get a hybrid learning facility here and can choose their batch timings (weekday or weekend) at their convenience to upskill with data science programs in Kolkata.               ",
              open: false,
            },
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              ...
              ans: `Learnbay offers flexible financing options for paying data science course fees in Kolkata. You can opt for no-cost EMI, installments, or interest-free loans to pay the fee within 12 months. 
            ...
            },
            {
              ...
              ansAfter: " enrolling. The policy mentions that learners can withdraw their data science fees in Kolkata.           ",
              link:true,
              open: false,
            },
      ...
      DomainBot1:
        "Data has become a part and parcel of our lives, positively lifting our lifestyle. Similar advances are seen across diverse business sectors, paving the way for competitive outputs. Data science presence in various domains triggers the search for skillful data scientists in Kolkata.         ",
      DomainBot2:
        "Learnbay offers domain-specific upskilling to experts eager to switch or update their careers. We focus on an inclusive data science training program in Kolkata that equips you with proven skills to excel in any domain.         ",
      DomainBot3:
      ...
      DomainBot40:
        "Experts with at least 6 months of work experience (full/part-time) can join the best data science institute in Kolkata to refine their domain skills.         ",
      CertificationHead1: "",
      CertificationBot1:
        "In the 21st Century, digital creations have become central to altering several businesses and job market outlooks in Kolkata. Constant skill upgrades as per the latest trends help work experts. However, having generic skills without validation is futile and cannot achieve desirable success. Hence, enrolling in the data science certification in Kolkata with globally valued credentials is worth investing in.         ",
      CertificationBot2:
      ...
      ModuleMasterlist1:
        "Essential knowledge of statistical functions        ",
      ...
      ModuleMasterBot2:
        " Our cutting-edge data science institute in Kolkata is widely famous for its live instructor-led domain-specific learning. Here, experts learn more about trending data science concepts and tools via abstract and practical training. Our constantly updated course modules equip learners with proven skills to thrive across leading MNCs.         ",
      ModuleMasterBot3:
      ...
      JobHead1:
        "What crucial technical skills can you acquire with Learnbay’s best data science course in Kolkata?         ",
      ...
      JobBot003:
        "Experts joining the best data science course in Kolkata will receive end-to-end career support services – from mock interviews to resume building. Yet, to receive all these benefits, one must have a minimum score of 70% in coursework and projects. Completing tasks and projects will help you gain the utmost career change benefits with promising hikes and promotions.         ",
      JobBot39: "Exclusive gains that our Career Service PRO will offer are –      ",
      ...
      Joblist16: " Endless job calls from Kolkata-based MNCs and other prime regions and resume building with job-ready skills     ",
      Joblist17: "LinkedIn profile review     ",
  
      JobHead30: "",
  
      JobBot21:
        "Note: Now, our dedicated career support team is available 24/7 to help you with all your career-related queries and provide the best possible solutions via counseling.         ",
      JobHeadIndia01: "         ",
      JobBot22:
        "  ",
        JobHeadIndia01:
      ...
      JobHead001: "   Is learning via Learnbay’s best data science course in Kolkata worth investing in?   ",
      JobBotMasterBot5:
        "In Kolkata, several sectors are arising with strategic moves to attain competitive success. Data science is one of the contributing factors, leveling up business growth with eternal gains. In addition to this, the demand for skilled data science professionals brings upskilling via an industry-paced data science course in Kolkata into the spotlight. Hence, data science learning is valuable, but joining a generic course can demean your skills and growth options.      ",
      JobBot007:
      ...
      JobBot25:
        "Working pros willing to relaunch their careers in the data science field must enroll in our courses. Regardless of the data science course in Kolkata fees, joining us unlocks a rewarding career path with tempting offers.         ",
  
      ProjectsHead1:
        "How far does Learnbay’s hands-on learning approach via projects help you sustain a bright data science career in Kolkata?         ",
  
      ProjectsBot1:
        "Learnbay believes in a 360-degree knowledge-building process that helps working pros modernize their careers in the data science field. Upskilling has become vital owing to the dawn of data science in Kolkata and its definite presence. Thus, Learnbay guides such prospects in learning and practicing the significant tools.         ",
      ProjectsBot3:
        "Data science is a diversified field with vast uses across several sectors. Additionally, the field keeps changing and enriching its force, requiring constant skill upgrades and changes. Hence, working experts in this field or eager to pursue a career in data science must gain industry-specific knowledge. Even employers from leading MNCs search for skillful data scientists with proven expertise.         ",
      ProjectsBot4:
        "The best data science course in Kolkata crafts an irrefutable career growth path that helps working pros learn and thrive. Regardless of data science course fees in Kolkata, learning is vital to sustain yourself in this changing field. Hence, our cutting-edge data science programs in Kolkata with real-time projects guide you in this. It equips you with proven skills to stay ahead of the career race and land your dream job.         ",
      ProjectsBot5:
        "Here, you will learn about data science and its uses via domain-specific real-time projects. We cover the top-tier domains such as BFSI, HR, Marketing, Healthcare, Supply Chain, and Manufacturing. Apart from learning, you will also receive an IBM project certificate that validates your skills on a global scale. Hence, learning with our exclusive data scientist course in Kolkata helps build a promising data science career.         ",

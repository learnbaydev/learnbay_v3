export const MasterAI = {
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A master’s degree in Data Science unlocks career opportunities in various industries and many domains. Some promising career roles are – - Data Scientist or Data Engineer - AI Rese - arch Scientist - Business Intelligence Analyst - MLOPs Engineer - Product analytics - Data Analyst - Natural Language Processing (NLP) Engineer"
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "If you enroll in a master’s in Data Science and AI program, you will have the scope to choose any specialization you wish. This program has two specialization options – - Specialization 1: Data Science and Analytics (12 months) - Specialization 2: Artificial Intelligence & ML (12 months) Apart from a foundation module, learners will upskill their expertise in any of the specializations."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learnbay offers flexible financing options for learners to have constant upskilling. You can pay the fees in installments under a no-cost EMI option within 12 months. You can also opt for interest-free loans with the necessary documents (Aadhar card, PAN card, & salary slip)."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The Data Science and AI master’s degree program offers a 15% – 20% discount for early birds occasionally. Yet, a group discount is available for the learners who join with one or more friends. Group of 2: 5% extra discount Group of 3: 8% additional discount Group of 4+: Max 10% discount For further details, you can check with our sales team at +91 7795687988"
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, learners get the chance to work on real industry projects and gain hands-on experience for better exposure to business challenges. Learnbay offers an open learning platform that supports real-time skills upgrades. Click here to download the list of the projects."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "For this master’s program, learners will get unlimited interview calls from MNCs/MAANG worldwide. Based on their domain specialization, learners will get interview calls and if found suitable can apply for further processes."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Learners, who successfully complete the course (training, tasks, and projects) with a minimum of 70% marks are eligible for the Career Service Pro feature. Under this feature, they will get – 3 years of Job and Placement help 6 Mock Interviews with Industry Experts 1:1 Review Session Unlimited Interview Calls"
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, Learnbay offers 100% job assistance services to learners opting for a master’s program. Learners get a career service pro package after course completion. The program supports learners with 100% job assistance with resume preparation and unlimited job calls."
    }
  },{
    "@type": "Question",

export const DataScienceCourseData = [
  {
    ...
    DomainBot2:
      " Our leading-edge data science course institute offers domain-specific training sessions to enrich your prior knowledge. It helps you note down real issues and tackle them with the right methods. Learnbay’s best data science courses follow the trending domains to align them for upskilling. Such domain electives are –      ",
    DomainBot3: "",
    DomainList1: "• BFSI",
    DomainList2: "• HR",
    ...
    DomainBot40:
      "Experts can opt for any data science online course and choose the right domain for exciting career growth options.",
    DomainBot41:
      "Apart from domain electives, our master’s data science course has two domain specializations. Here, learners must select any one domain specialization as per their interests. In short, experts must opt for one domain specialization in their preferred elective to continue upskilling.",
    ...
    MasterJobBot2:
      "By the end of our data science training, you will have expertise in –     ",

    Joblist1: "Introduction to data science to industry cases         ",
    Joblist2: "Insightful data analysis      ",
    Joblist3: "Statistical analysis         ",
    Joblist4: "Predictive modeling       ",
    Joblist5: "Efficient coding with programming languages         ",
    Joblist6: "Applied data science tools and trends        ",
    Joblist7: "Deep learning tools and uses        ",
    Joblist8: "Dashboard creation with facts       ",
    Joblist9: "Big data analytics         ",
    Joblist10: "Business intelligence tools        ",
    Joblist11: "GenAI trends (ChatGPT)        ",
        ...
        data: [
          {
            ...
            list2:
              "Data Science and AI Program for Freshers – 6 months             ",
            list3:
              "Advanced Data Science and AI Certification – 7 months             ",
            list4:
              "Data Science and AI Master Certification Program – 13 months,             ",
            list5:
              "Master’s in CS: Data Science and AI – 18 months             ",
        ...
        data: [
          {
            ...
            list2:
              "Data Science and AI Program for Freshers – ₹70,000 + 18% GST              ",
            list3:
              "Advanced Data Science and AI Certification – ₹99,000 + 18% GST              ",
            list4:
              "Data Science and AI Master Certification Program – ₹129,000 + 18% GST              ",
            list5:
              "Master’s in CS: Data Science and AI – ₹250,000 + 18% GST              ",
          ...
          },
          {
            ...
            list2:
              "We also offer a 15% – 20% discount for early birds occasionally. Yet, a group discount is available for the learners who join with one or more friends.               ",

export const ExcutiveProgramAIDS = [
  {
    sections: [
      {
        id: "0",
    ...
    faq: [
      {
        ...
        data: [
          ...
          },
          {
            ...
            list8:
              "Offline capstone project handling in selective cities - Bangalore, Pune, Delhi, Chennai, Hyderabad, and Mumbai",
            dscoursefaq1: true,
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            ...
            ans: "At Learnbay, we offer Job-readiness with interview support. You can attend these interviews until you land a job with top MNCs.",
            open: false,
          },
          {
            id: 2,

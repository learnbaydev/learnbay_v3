export const HRDataScienceCourseData = [
  {
    secondSection: [
      {
        id: 1,
        ...
        data: [
          {
            ...
            ans: 'We offer industry-specific full-stack HR modules, via which you learn the respective industry’s best practices.The total program fee for the HR Program is INR 1,20,000 + 18% GST.',
            open: true,
          },
          {
            id: 1,

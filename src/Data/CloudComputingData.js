export const CloudAndDevOpsCourseData = [
  {
    secondSection: [
      {
        id: 1,
    ...
    Certificate: {
      degreeCertificate: {
        ...
        para: [
          ...
          'Validate your Cloud Computing & Cloud Computing skills with IBM Course Completion Certificate.',
            ...
            },
            {
              chap: {
                ...
                desc: [
                  ...
                  "'Modernizing Legacy Applications with Azure': Migrating and modernizing legacy applications to the Azure cloud, leveraging Azure Kubernetes Service and Azure Cloud Computing for continuous integration and delivery.",
                ],
              },
            },
          ],
...

      {
        Module0: {
          ...
          content: [
            ...
            {
              chap: {
                title: 'Module 4 :- Case Studies and Real-World Applications',
                desc: [
...

      {
        Module0: {
          ...
          content: [
            ...
            {
              chap: {
                title: 'Module 2 :- Advanced Splunk Skills',
                desc: [
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is the duration of the Cloud Computing Certification Course?              ',
            ans: 'You can become a certified Cloud Computing engineer in 7 months of instructor-led training with flexible training sessions (weekdays & weekends).               ',
            open: true,
          },
          {
            id: 1,
            ques: 'What prerequisites are required to enrol in this certification program?              ',
            ans: 'The Cloud Computing course is beginner-friendly, and IT/non-IT experts can opt for this. You can join this program with a basic knowledge of statistics/mathematics and fundamental concepts of IT. It teaches technical skills with programming languages from scratch.               ',
            open: false,
          },
          {
            id: 2,
            ques: 'Is this certification program suitable for beginners in IT?              ',
            ans: `Yes, this certification is suitable for beginners in the IT domain. Freshers in IT can enrol in Cloud Computing courses to learn in-demand tools. IT pros eager to learn promising Cloud Computing skills can opt for this program. You will get an open learning experience with renowned faculties and become job-ready.               `,
            open: false,
          },
          {
            id: 3,
            ques: 'What cloud platforms are covered in the program?              ',
            ans: `During the cloud computing classes, we will cover Google Cloud Platform, Microsoft Azure, and Amazon AWS concepts and tools to craft an unbeatable Cloud career.               `,
            open: false,
          },
          {
            id: 4,
            ques: 'Are there any real-world projects or case studies included in the program?              ',
            ans: 'The Advanced Cloud Computing Certification Course includes ten real-time projects and some case studies in different learning modules. Real-time projects help experts explore the practical use of learned tools and tackle issues well. Case studies and practical exercises help learners enrich their knowledge concerning the latest trends.               ',
            open: false,
          },
          {
            id: 5,
          ...
          },
          {
            ...
            ans: 'Learnbay follows each significant industrial/job market incident across the global IT sector and its impacts on specific job roles. Quality industry research, networking with industry experts, and tie-ups with leading MNCs & unicorn startups keep us updated with the latest trends in Cloud Computing. In the same way, our course syllabus has been revamped as per the recent developments with AWS, Microsoft Azure, and GCP.               ',
            open: false,
          },
          {
            id: 7,
            ques: 'How does this program prepare students for real-world cloud computing challenges?              ',
            ans: 'This program prepares students to face real-world cloud computing challenges. Its instructor-led training sessions by industry experts shall help you get versed in real-time issues linked to Cloud Computing.               ',
            open: false,
          },
        ],
      },

      {
        ...
        data: [
          {
            id: 0,
            ques: 'How much does the Advanced Cloud Computing Certification Course cost?              ',
            ans: 'The Cloud Computing certification course fee is INR 1,20,000 + 18% GST.               ',
            open: true,
          },

          {
            ...
            ans: 'Yes, we have an instalment payment facility where you need to pay INR 4,917 per month. You can make payments through Credit card, UPI, or Internet banking.               ',
            open: false,
          },
          {
            id: 2,
            ques: 'Can I pay for the course using credit cards, and are other payment methods accepted?              ',
            ans: 'Yes, you can use credit cards to pay for the course. Some other payment options like UPI or Internet banking are also available.              ',
          ...
          },
          {
            ...
            ans: 'You must contact and book a counselling session with a career counsellor to get details of the course and scholarship schemes. It will be a telephone discussion of 15 – 20 minutes.               ',
            open: false,
          },
          {
            id: 5,
            ques: 'Are there any discounts for early registration in the program?              ',
            ans: 'Yes, we offer 15% – 20% early bird discounts for learners registering in the program at first. However, a group discount is available for learners who join with one or more friends.               ',
            open: false,
          ...
          {
            id: 7,
            ques: 'Are there any extra costs for course materials, textbooks, or certification exams?                ',
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'How many real-time projects will be there in the Cloud Computing course?              ',
            ans: 'You will get 10+ real-time projects with this Cloud Computing certification course in different areas of expertise.               ',
          ...
          {
            id: 2,
            ques: "Could you elaborate on the capstone project's significance in the certification program?              ",
            ans: `Capstone projects encompass the skills to see through real business scenarios and tackle them with proven expertise. It arms you with a set of skills and expands your earning limits. It consists of stimulated projects that help you practice the in-demand tools. It helps assess your skills and knowledge and makes room for improvement in the desirable field. Plus, capstone projects have the significance of building an unbeatable project portfolio and validating your skills.               `,
            open: false,
          },
        ],
      },
        ...
        data: [
          {
            ...
            ans: 'Yes. Once you complete the course and projects, you will obtain globally accredited certifications from IBM & Microsoft.                ',
            open: true,
          },
          {
            id: 1,
            ques: 'Is the certification internationally recognized?              ',
            ans: `Yes, the globally recognised certification enriches your career and validates the learned skills for better job prospects.               `,
            open: false,
          },
          {
            id: 2,
            ques: 'What type of certification do I receive upon course completion?              ',
            ans: `Upon completing the course, you will receive two course certificates from IBM & Microsoft and a Project Certificate from IBM.               `,
            open: false,
          },
          {
            id: 3,
            ques: 'Are there any extra costs associated with the certification program?              ',
            ans: `The Cloud Computing course with certification has no other costs besides the course fees.               `,
            open: false,
          },
        ],
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'How does this course cater to learners interested in pursuing a career as a Cloud Computing Engineer?              ',

            ans: `The Cloud Computing certification course aims to support career-building and promising job roles. Working experts eager to pursue a career as a Cloud Computing engineer will get uninterrupted training sessions. Hands-on learning of tools helps learners future-proofing their skills with assured job offers. Its 100% dedicated placement support helps experts crack fortunate job offers across MNCs/MAANG with better pay cheques.               `,
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 2,
            ques: ' Can you provide details on the job assistance after completing the Cloud Computing Certification Course?              ',
            ans: 'Learners are offered end-to-end job assistance after completing the Cloud Computing course with certification. Learners with a minimum of 70% in assessments and completed projects are eligible to get job assistance from Learnbay. We have a Career Service Pro deal for eligible learners where they will get benefits like –               ',
          ...
          },
          {
            ...
            list3:
              '- Training on in-demand Cloud Computing tools              ',
            list4:
              '- 100% career support service (Career Service Pro)              ',
            list5:
          ...
          {
            id: 4,
            ques: "Explain Learnbay's Career Service Pro. Can I opt for Career Service Pro for the advanced Cloud Computing course?                ",
        ...
        data: [
          {
            ...
            ans: 'Yes, we believe in industry-driven mentorship to justify career transition. We have renowned faculties from promising MNCs/MAANG who mentor our learners. Once you enrol in the course, we will assign you a mentor/instructor to guide you throughout the course. Mentors guide you with real work experiences so that you can tackle the issues with proven solutions.               ',
            open: true,
          },
          {
            id: 1,
            ques: 'Are there mentors available to help with coursework and projects?              ',
            ans: 'Our experienced mentors are there to help you with coursework, case studies, practical exercises, and real-time projects. Learners will gain insights into real-world uses of Cloud Computing. Mentors help learners with 1:1 doubt-clearing, offline project handling, and coursework activities. Thus, you will get complete support from your mentor and valuable results.               ',
            open: false,
          },
          {
            id: 2,
            ques: 'How can I connect with a mentor?              ',
            ans: 'An industry-specific mentor is assigned to learners registering with the Cloud Computing certification course. You can contact your mentor 24/7 directly via the Learnbay app. You can contact them personally over the phone or via app chat sessions.               ',
            open: false,
          },
          {
            id: 3,
            ques: 'What is the typical response time for mentor support?              ',
            ans: 'After enrolling in the Cloud Computing training institutes, you can get along with your mentor for each discussion or need. Our mentors support your queries anytime (during and after the training sessions). So, within 10–15 minutes, you can get mentor support to resolve queries concerning coursework or live projects.               ',
            open: false,
          },
        ],
      },
        ...
        data: [
          {
            ...
            ans: 'Learnbay has a centralized technical support system to help learners with related issues during the course. This technical aid is open 24/7 to solve all your questions instantly. If you face technical issues during login, logout, training sessions, attendance, or other issues, our dedicated experts are here to help.               ',
            open: true,
          },
          {
            id: 1,
            ques: 'What kind of training help is available for students enrolled in the Cloud Computing Certification Course?              ',
            ans: 'After enrolling in the Cloud Computing training with placement, learners will get support for –              ',
            list1: 'Technical/non-technical issues              ',
            list2: 'Contacting with mentors               ',
            list3: '1:1 clarification              ',
            list4: 'Course materials              ',
            list5: 'Coursework and project handling help              ',
            list6: 'Career Service Pro (Job assistance)              ',
            dscoursefaq1: true,
            open: false,
          },
          {
            id: 2,
            ques: 'How can students get assistance with course materials or clarification on concepts related to Cloud Computing?              ',
            ans: 'Dedicated mentorship is an effective solution for clarification of concepts and 360-degree knowledge-building. You can directly reach your mentor in case of doubts or need further clarification on Cloud Computing concepts. The Learnbay app is the contact medium to share your misgivings about course materials and training.               ',
            open: false,
          },
          {
            id: 3,
            ques: 'Is there specific support available for those preparing for Cloud Computing certification exams?              ',
            ans: 'Career Service Pro is an exclusively designed solution for learners preparing for cloud certification exams or placement. It helps learners with 1:1 doubt clearing, mock interviews, mentorship, resume building, and soft skills training. Learners can reach their mentors at any time to get support in certification exams or appear in job interviews.               ',
            open: false,
          },
        ],
      },

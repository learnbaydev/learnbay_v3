export const DataScienceCourseData = [
  {
    ...
    upskillingData:[
...

      {
        ...
        useCases: "Build a chatbot using GPT-3 for query handling and RNN- based sentiment analysis",
        toolImage:
    ...
    sections:[
      {
        ...
        contentDescription: "",
        contentDetails: ["Installation & Setup",
             "Basic Syntax & I/O",
        ...
        },
        {
            ...
            contentDetails: ["Python Environment Setup",
                 "Python Syntax and Code Structure",
    ...
    
            {
                ...
                contentDetails: ["Fundamentals of Math and Probability",
                     "All about Population & Sample",
    ...
    
                {
    ...
    
                    {
                        ...
                        contentDetails: ["Introduction to Deep Learning and TensorFlow",
                             "TensorFlow Classification ExamplesL",
                        ],
                        popuplist: [
                          {
                            term: "Moudle 0",

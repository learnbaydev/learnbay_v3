export const IITCyberSecurityData = [
  {
    ...
    summarySection: [
      ...
      },
      {
        ...
        description:
          "Build end-to-end  projects Cyber Security with practical hands-on training.",
        imageSrc:
    ...
    masterSyllabusMobile: [
      ...
      {
        Module0: {
          title: "ADD-ON TERM :- CISSP Exam Preparation",
          imageUrl:
            "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Gen_AI_syll.webp ",
          StartImageUrl:
            " https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/ARTIFICIAL+INTELLIGENCE_down.webp",
          ...
          content: [
            {
              chap: {
                title: "Module 1: Security & Risk Management + Asset Security",
                desc: [
                  "Security governance, compliance (ISO 27001, GDPR), risk management, BCP/DRP .",
                  "Cryptography basics, data protection, and secure storage policies.",
                  "Hands-on: Conduct a risk assessment & encrypt data using AES/RSA.",
                ],
              },
            },
            {
              chap: {
                title:
                  "Module 2:Network Security + Identity & Access Management (IAM)",
                desc: [
                  "Secure network design, firewall configurations, IAM, MFA , and Zero Trust",
                  "Cloud security models, VPNs, and endpoint security.",
                  "Hands-on: Configure IAM policies & firewall rules in a simulated environment.",
                ],
              },
            },

            {
              chap: {
                ...
                desc: [
                  "Threat detection, penetration testing, vulnerability assessment, and SIEM tools.",
                  "Digital forensics, security audits, and breach investigation",
                  "Hands-on: Perform a vulnerability scan & simulate an incident response plan.",
                ],
              },
            },
            ...
            {
              chap: {
                title: "Module 4: CISSP Exam Strategy & Mock Test",
                desc: [
                  "CISSP domain breakdown, question formats, testtaking strategies.",
                  "Case study analysis & real-world application of CISSP concepts.",
                  "Hands-on: Attempt a full-length CISSP mock test & review key topics",
                ],
                note: " # CISSP module does not include exam voucher",
              },
            },
          ],
          id: 5,
    ...
    toolsData: [
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/pyhton-tools.webp",
        alt: "Tool 1",
      },
      {
      ...
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/kali-tools.webp",
        alt: "Tool 3",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/iam-tool.webp",
        alt: "Tool 4",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/opem-tools.webp",
        alt: "Tool 5",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/ubunutu-tools.webp",
        alt: "Tool 6",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/vm-tools.webp",
        alt: "Tool 7",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/azure-tools.webp",
        alt: "Tool 8",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/spluck-tools.webp",
        alt: "Tool 9",
      },
      {
        src: "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/tools/sec-tools.webp",
        alt: "Tool 10",
      },
    ],
    Certificate: {

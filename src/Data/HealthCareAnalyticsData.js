export const HealthcareDataScienceCourseData = [
  {
    secondSection: [
      {
        id: 1,
          ...
          content: [
            {
              chap: {
                ...
                desc: [
                  ...
                  'BA/BE Studies, Clinical trial design, Clinical Trial Regulatory Affairs, Intellectual Property Rights and Patent Laws',
                  'Data-Based Patient Selection.',
                  'Real-Time Monitoring from trials to ensure safety and minimise operational risks.',
                  'Drug Safety Assurance to predict in advance whether a compound will provoke an adverse reaction before it even reaches trial.',
                  'Determining which customers and doctors are more likely to use a medication and devising more tailored on-the-ground marketing strategies, using predictive techniques. ',
                  'Patterns in drug-drug interactions, what drives patients to stop taking medications, which patients will not stick to the prescriptions.',
                ],
              },
            },
          ],
    ...
    faq: [
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What are the prerequisites for the Data Science and AI for Healthcare Professionals Program?',
            ans: 'There are no prerequisites for this Data Science and AI for Healthcare Professionals certification course as all modules are beginner-friendly and are taught from scratch. We provide special classes and assistance for Non-IT/Non-programmers. However, basic knowledge of applied Mathematics/Statistics is a must.',
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 2,
            ques: 'What is a Flexi Subscription in the Data Science and AI for Healthcare Professionals Program?',
            ans: `Those who enroll for Data Science and AI for Healthcare Professionals live classroom training are eligible for a Flexi Pass. With this option, we will share access to all the ongoing batch details for a period of 1.5 year, so that you can attend live sessions from any batch and learn at your own pace. This option is best for people working in shifts or on weekends.`,
            open: false,
          },
          {
            id: 3,
            ques: 'What’s the duration of the Data Science and AI for Healthcare Professionals Program?            ',
            ans: 'The duration of the Data Science and AI Certification Program for Healthcare Professionals program is 7 months which includes live lectures, hands-on practical training on live projects, and interview preparations. Classes will be conducted on weekdays and weekend batches. Weekday batch (Monday to Friday – 2 hours/day), Weekend batch (Saturday & Sunday – 3.5 hours/day). ',
            open: false,
          },
          {
            id: 4,
            ques: 'What is the mode of Data Science and AI for Healthcare Professionals training at Learnbay?',
            ans: 'We provide both classroom and online Data Science and AI for Healthcare Professionals training modes. Based on your requirement, you can choose your preferred mode.',
            open: false,
          },
          {
            id: 5,
      ...
      },
      {
        ...
        data: [
          {
            id: 0,
            ques: 'What is the total fee for the Data Science and AI for Healthcare Professionals Program?            ',
            ans: 'The total program fee for the Data Science and AI Certification Program for Healthcare Professionals program is INR 1,59,000 + 18% GST. ',
            open: true,
          },
          {
            id: 1,
          ...
          {
            id: 3,
            ques: 'What is the refund policy for the Healthcare Program at Learnbay?',

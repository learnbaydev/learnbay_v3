import {
  ...
  export const AImastersDataScienceCourseData = [
    {
      secondSection: [
        {
          id: 1,
          ...
          para: "Talk to an expert and receive real-time solutions to your queries",
        },
        {
          id: 1,
          ...
          para: "Explore job prospects with referrals from 300+ top hiring partners",
        },
        {
          id: 1,
          ...
          para: "Master the domain of data science with certificate from IBM",
        },
        {
          id: 1,
          ...
          para: "Develop sought-after skills for better promotion & higher salary",
        },
      ],
      testimonial: [
        {
      ...
      thirdSection: [
        ...
        },
        {
          ...
          para: "Minimum 6 months of work experience",
        },
        {
          id: 1,
        ...
        },
        {
          ...
          heading: "Aspirations",
          para: "Preparing for future leadership opportunities in data science",
        },
      ],
      fourthSection: [
        {

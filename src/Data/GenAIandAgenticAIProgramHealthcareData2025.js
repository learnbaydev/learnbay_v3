...
export const NewDSAData = [
  {
    ...
    masterSyllabusMobile: [
      ...
      {
        Module5: {
          title: "Term 5 – Gen AI Specialization for Healthcare Professionals",
          hours: "(1 Months)",
          imageUrl:
            "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/SyllabusIcon/data_science_tRound.webp",
          StartImageUrl:
          ...
          endImageUrl:
            "https://d32and0ii3b8oy.cloudfront.net/web/s3_main/Course-home/SyllabusIcon/round_yellow_ups.webp",
          points: "Agentic AI & Healthcare Domain Fundamentals",
          content: [
            {
              chap: {
                title: "Healthcare Domain Fundamentals",
                desc: [
                  "Healthcare workflows: patient intake → diagnosis → treatment → documentation → billing",
                  "Pharma workflows: R&D → clinical trials → manufacturing → safety → pharmacovigilance",
                  "Key metrics: ADRs, trial duration, readmission rate, LOS, claim turnaround, safety compliance",
                ],
              },
            },
          ],

...
export const BADataScienceCourseData = [
    ...
    sections:[
      {
        ...
        {
        moduleTitle: "Section 1",
        moduleContent: "Introduction and Data Preparation",
        moduleList: [
 ...
 {
        moduleTitle: "Section 2",
        moduleContent:"Descriptive and Predictive Analytics",
        moduleList: [
 ...
 {
            moduleTitle: "Section 3",
            moduleContent:" Business Decision-Making with Analytics",
            moduleList: [
                "Using Analytics for Strategic Decision-Making",
                "Hands-on Project",
...

 {
                ...
                moduleList: [
                "Introduction to AWS and Azure Services",
...

     {
        ...
        
        {
            ...
            duration: "50-55 hrs",
            contentModule: "Section 1 -",
            contentDescription: "Introduction and Data Preparation",
            contentDetails: [
                "Introduction to Business Analytics", 
                "Data Collection and Cleaning",
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            ...
            ans: "Yes, you can pay the installments using a credit card with a no-cost EMI option for INR 6,228/month up to 18 months. You can also choose an interest-free loan by submitting an Aadhar card, Pan Card, and 3-month salary slip.",
            open: false,
          },
          {
            id: 2,
